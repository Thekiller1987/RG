import{r as i,j as e,I as je,X as Dr,Y as Nr,aP as ve,aQ as Y,ah as L,aa as X,ag as G,aR as ye,$ as Ge,aS as Pr,aN as _r,am as Ce,ac as qe,a4 as Ue,k as J,aT as we,s as d,ae as de,t as tr,V as Tr}from"./vendor-BVroOj2J.js";import{E as kr}from"./pdf-vendor-C0MaOehg.js";import{u as $r,I as Ir,J as zr,K as Rr,L as Ye,M as Or,N as Br,O as Mr,P as Lr,Q as Vr}from"./index-fl4El2y-.js";import{r as Xe}from"./searchEngine-BMYcElFi.js";import"./scanner-vendor-DfxRpMWJ.js";const Ae=()=>new Date().toLocaleDateString("sv-SE",{timeZone:"America/Managua"}),T=o=>{if(!o)return"—";const j=new Date(o.includes("T")?o:`${o}T12:00:00`);return new Intl.DateTimeFormat("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}).format(j)},pe=tr`from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); }`,Hr=tr`from { transform: scale(0.95); opacity: 0; } to { transform: scale(1); opacity: 1; }`,Wr=d.div`
