import{r as s,j as e,k as le,D as pe,s as r,R as ee,I as G,x as me,af as te,q as xe,n as L,J as K,ag as P,ah as he,aa as ge,ai as fe,v as ue,T as Y,Y as be,aj as je,X as ye,ak as we,al as Ce,$ as ve,a4 as ae,Z as re,am as ne,an as H,V as ke}from"./vendor-Cig3sC1l.js";import{m as Se,n as $e,a as Ne,u as de,o as Ae,p as ze,q as De,r as Te,t as _e,j as Ie,v as Fe,w as Ee}from"./index-DGmyou13.js";import{T as ce,A as Le,S as Pe}from"./SalesHistoryModal-CAvgWj-X.js";import{M as Me,a as Oe,B as W}from"./POS.styles-aMw4GNpO.js";import{A as Be}from"./AlertModal-D7T3J0b6.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-Dyhe4TSt.js";import"./searchEngine-BMYcElFi.js";const Re=r.div`
...
`,We=r.div`display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;`,Ue=r.h2`margin:0;font-size:1.5rem;`,Ve=r.button`border:none;background:none;color:#dc3545;font-size:1.2rem;cursor:pointer;`,Ge=r.form`display:flex;flex-direction:column;gap:0.8rem;`,U=r.input`padding:0.6rem;border:1px solid #ccc;border-radius:6px;font-size:0.95rem;`,Ye=r.button`
  ...
  &:hover{opacity:0.85;}
`;function qe({client:a,onClose:b,onSave:m}){const[o,x]=s.useState(""),[u,g]=s.useState(""),[j,S]=s.useState(""),[v,l]=s.useState(""),k=localStorage.getItem("token");s.useEffect(()=>{a?(x(a.nombre||""),g(a.cedula||""),S(a.telefono||""),l(a.limite_credito||"")):(x(""),g(""),S(""),l(""))},[a]);const n=async d=>{d.preventDefault();const c={nombre:o,cedula:u,telefono:j,limite_credito:v===""?null:Number(v)};try{a?await Se(a.id_cliente,c,k):await $e(c,k),m&&m(),b()}catch($){console.error($),alert(`Error al guardar cliente: ${$.message}`)}};return e.jsx(Re,{children:e.jsxs(He,{children:[e.jsxs(We,{children:[e.jsx(Ue,{children:a?"Editar Cliente":"Nuevo Cliente"}),e.jsx(Ve,{onClick:b,children:e.jsx(le,{})})]}),e.jsxs(Ge,{onSubmit:n,children:[e.jsx(U,{value:o,onChange:d=>x(d.target.value),placeholder:"Nombre",required:!0}),e.jsx(U,{value:u,onChange:d=>g(d.target.value),placeholder:"Cédula / RUC"}),e.jsx(U,{value:j,onChange:d=>S(d.target.value),placeholder:"Teléfono"}),e.jsx(U,{type:"number",step:"0.01",value:v,onChange:d=>l(d.target.value),placeholder:"Límite de crédito"}),e.jsxs(Ye,{type:"submit",children:[e.jsx(pe,{})," Guardar"]})]})]})})}const Je=xe`
  @media print {
...
`,Xe=({statementData:a,filterType:b="ALL",onClose:m})=>{const{settings:o}=Ne(),{cliente:x,historial:u}=a,g=n=>new Intl.NumberFormat("es-NI",{minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(n||0)),j=u.filter(n=>b==="DEBT"?n.impacto>0:b==="PAID"?n.impacto<0:!0),S=b==="DEBT"?"HISTORIAL DE DEUDAS (CRÉDITOS)":b==="PAID"?"HISTORIAL DE PAGOS (ABONOS)":"ESTADO DE CUENTA COMPLETO",v=ee.useMemo(()=>{if(!(o!=null&&o.empresa_logo_url))return null;if(o.empresa_logo_url.startsWith("http"))return o.empresa_logo_url;let n=o.empresa_logo_url;return n.startsWith("/uploads")?n="/api"+n:n.startsWith("uploads")&&(n="/api/"+n),`${"https://sistema.multirepuestosrg.com/api".replace(/\/api$/,"")}${n.startsWith("/")?"":"/"}${n}`},[o==null?void 0:o.empresa_logo_url]),l={name:(o==null?void 0:o.empresa_nombre)||"Multirepuestos RG",ruc:(o==null?void 0:o.empresa_ruc)||"1211812770001E",phone:(o==null?void 0:o.empresa_telefono)||"84031936 / 84058142",address:(o==null?void 0:o.empresa_direccion)||"Del portón de la normal 75 varas al este. Juigalpa, Chontales.",slogan:(o==null?void 0:o.empresa_eslogan)||"Tu mejor opción en repuestos",logo:v||new URL("/icons/logo.png",window.location.origin).toString()},k=s.useCallback((n="80")=>{const d=document.getElementById("print-wrapper-statement");if(!d)return;const c=d.outerHTML,N=`
      @charset "UTF-8";
      @import url('https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;500;600;700;800;900&display=swap');
      @page { size: ${n==="A4"?"A4 portrait":"80mm auto"}; margin: ${n==="A4"?"12mm":"0"}; }
      html, body {
      ...
      #print-wrapper-statement {
        ...
        ${n==="A4"?"width: 100% !important; padding: 0 !important; font-size: 10pt !important;":"width: 80mm !important; padding: 6px 4px !important; font-size: 9pt !important;"}
      }
      ...
      .brand-logo-container img { 
        max-width: ${n==="A4"?"130px":"80px"} !important; 
        max-height: ${n==="A4"?"90px":"80px"} !important; 
