import{R as K,r as i,j as e,n as xt,J as ft,ab as ht,D as gt,s as p,v as ut,x as Le,aS as bt,ag as Pe,C as jt,q as yt,af as de,ba as Ct,b3 as Ue,h as Ge,bb as rt,bc as wt,K as vt,a_ as at,al as Nt,$ as Je,a0 as kt,U as $t,aQ as St,bd as At,be as Tt,a$ as it,aj as Dt,am as It,bf as Ze,ah as De}from"./vendor-Bl8eSE-Q.js";import{M as Se,B as A,f as q,a as Oe,I as Ae,S as ve}from"./POS.styles-C4qzct5K.js";import{u as Me,_ as Et,i as Ft,a as zt,m as Lt}from"./index-C2KciQq_.js";import{A as Mt}from"./AlertModal-C1eU8apX.js";const Rt=p.div`
...
`,Ot=p.h2`margin: 0; font-size: 1.5rem; color: #333;`,Vt=p.button`
  ...
  &:hover { color: #333; }
`,Bt=p.form`display: flex; flex-direction: column; gap: 1.25rem;`,Ie=p.div`display: flex; flex-direction: column; gap: 0.5rem;`,Ee=p.label`font-weight: 600; color: #495057; font-size: 0.9rem;`,Re=p.input`
...
`,Wt=p(Re).attrs({as:"select"})``,Ye=p.button`
...
`,ge=t=>`C$${Number(t||0).toFixed(2)}`,et=t=>t?new Date(t).toLocaleDateString("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}):"—",Gt=({client:t,onClose:o,onAbonoSuccess:x,showAlert:f})=>{const{addCajaTransaction:w,user:u}=Me(),[d,k]=i.useState(""),[C,L]=i.useState("Efectivo"),[b,s]=i.useState(""),[T,E]=i.useState(!1),[I,a]=i.useState(""),[S,j]=i.useState([]),[M,m]=i.useState(!0),[g,X]=i.useState(null),V=i.useMemo(()=>Number(t==null?void 0:t.saldo_pendiente)||0,[t]);i.useEffect(()=>{const c=async()=>{m(!0);try{const v=localStorage.getItem("token"),_=await Ft(t.id_cliente,v);j(Array.isArray(_)?_:[])}catch(v){console.error("Error cargando tickets:",v),j([])}finally{m(!1)}};t!=null&&t.id_cliente&&c()},[t]);const D=i.useMemo(()=>S.filter(c=>c.saldoRestante>0),[S]),re=i.useMemo(()=>S.filter(c=>c.saldoRestante<=0),[S]),R=g?Math.min(V,g.saldoRestante):V;i.useEffect(()=>{if(!d){a("");return}const c=parseFloat(d);isNaN(c)||c<=0?a("Ingrese un monto válido mayor a cero."):c>R?a(`El máximo es ${ge(R)}.`):a("")},[d,R]);const ae=c=>{c.saldoRestante<=0||(X(v=>(v==null?void 0:v.idVenta)===c.idVenta?null:c),k(""))},ee=()=>{k(g?g.saldoRestante.toFixed(2):V.toFixed(2))},F=i.useCallback((c,v,_,z)=>{const N=Math.max(0,z-c),ce=new Date().toLocaleString("es-NI",{timeZone:"America/Managua"}),te=g?`Venta #${g.idVenta}`:"Cuenta General",U=`
    ...
    `,P=window.open("","_blank","width=400,height=600");P&&(P.document.write(`<!DOCTYPE html><html><head><title>Comprobante Abono</title><link href="https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;700;900&display=swap" rel="stylesheet"><style>@page{size:80mm auto;margin:0;}body{margin:0;padding:0;-webkit-print-color-adjust:exact;print-color-adjust:exact;}*{font-weight:800!important;color:#000!important;}</style></head><body>${U}</body></html>`),P.document.close(),P.focus(),P.onload=function(){setTimeout(()=>{P.print(),setTimeout(()=>P.close(),500)},400)})},[t,g]),r=i.useCallback(async c=>{c.preventDefault();const v=parseFloat(d),_=localStorage.getItem("token");if(I||!v||v<=0){f==null||f({title:"Monto Inválido",message:I||"Revise el monto ingresado."});return}if(C!=="Efectivo"&&!b.trim()){f==null||f({title:"Referencia Requerida",message:"Ingrese el número de referencia, transferencia o voucher."});return}E(!0);try{await Et(t.id_cliente,{monto:v,id_venta:(g==null?void 0:g.idVenta)||null,pagoDetalles:{metodo:C,usuario:(u==null?void 0:u.nombre_usuario)||"Desconocido",referencia:b||"",ticketRef:g?`Venta #${g.idVenta}`:"FIFO"}},_);const z=C==="Efectivo",N={id:`abono-${Date.now()}`,type:"abono",amount:v,note:`Abono Cliente: ${t.nombre} (${C})${g?` - Venta #${g.idVenta}`:""} ${b?"- Ref: "+b:""}`,at:new Date().toISOString(),pagoDetalles:{clienteId:t.id_cliente,clienteNombre:t.nombre,metodo:C,referencia:b,ingresoCaja:z?v:0,efectivo:z?v:0,tarjeta:C==="Tarjeta"?v:0,transferencia:C==="Transferencia"?v:0,credito:0}};await w(N),F(v,C,b,V),x==null||x(N),o==null||o()}catch(z){console.error("Error al registrar abono:",z),f==null||f({title:"Error",message:`No se pudo registrar el abono. ${z.message}`})}finally{E(!1)}},[d,C,b,I,t,u,g,w,x,o,f,F,V]),Z=T||V<=0||!!I||!d;return e.jsx(Rt,{children:e.jsxs(_t,{children:[e.jsxs(Pt,{children:[e.jsx(Ot,{children:"Registrar Abono"}),e.jsx(Vt,{onClick:o,disabled:T,children:e.jsx(xt,{})})]}),e.jsxs("p",{children:["Cliente: ",e.jsx("strong",{children:(t==null?void 0:t.nombre)||"Desconocido"})]}),e.jsxs(qt,{children:["Saldo Pendiente Total: ",e.jsx("strong",{children:ge(V)})]}),M?e.jsxs("div",{style:{textAlign:"center",padding:"1rem",color:"#6c757d"},children:[e.jsx(Qe,{})," Cargando facturas..."]}):D.length>0?e.jsxs(e.Fragment,{children:[e.jsxs(Ut,{children:[e.jsx(ft,{})," Selecciona una factura (opcional — si no, paga la más antigua):"]}),e.jsx(Ke,{children:D.map(c=>e.jsxs(Xe,{$selected:(g==null?void 0:g.idVenta)===c.idVenta,onClick:()=>ae(c),children:[e.jsxs("div",{className:"ticket-info",children:[e.jsxs("span",{className:"ticket-id",children:["Venta #",c.idVenta]}),e.jsx("span",{className:"ticket-date",children:et(c.fecha)})]}),e.jsxs("div",{className:"ticket-amounts",children:[c.montoOriginal!==c.saldoRestante&&e.jsx("div",{className:"original",children:ge(c.montoOriginal)}),e.jsx("div",{className:"remaining",children:ge(c.saldoRestante)})]})]},c.idVenta))}),re.length>0&&e.jsxs("details",{style:{marginTop:"0.5rem"},children:[e.jsxs("summary",{style:{cursor:"pointer",fontSize:"0.85rem",color:"#6c757d"},children:[e.jsx(ht,{style:{color:"#28a745"}})," ",re.length," factura(s) pagada(s)"]}),e.jsx(Ke,{style:{marginTop:"0.5rem"},children:re.map(c=>e.jsxs(Xe,{$paid:!0,children:[e.jsxs("div",{className:"ticket-info",children:[e.jsxs("span",{className:"ticket-id",children:["Venta #",c.idVenta]}),e.jsx("span",{className:"ticket-date",children:et(c.fecha)})]}),e.jsx("div",{className:"ticket-amounts",children:e.jsx("div",{className:"remaining",style:{color:"#28a745"},children:"Pagada ✔"})})]},c.idVenta))})]})]}):null,e.jsxs(Bt,{onSubmit:r,children:[e.jsxs(Ie,{children:[e.jsxs(Ee,{htmlFor:"montoAbono",children:["Monto a Abonar (C$)",g&&e.jsxs("span",{style:{fontWeight:"normal",color:"#007bff",marginLeft:"0.5rem"},children:["— Venta #",g.idVenta," (máx: ",ge(R),")"]})]}),e.jsxs("div",{style:{display:"flex",gap:"0.5rem"},children:[e.jsx(Re,{id:"montoAbono",type:"number",value:d,onChange:c=>k(c.target.value),placeholder:"0.00",required:!0,autoFocus:!0,step:"0.01",min:"0.01",max:R?R.toFixed(2):void 0,disabled:T||V<=0,style:{flex:1}}),e.jsx(Ye,{type:"button",onClick:ee,style:{background:"#007bff",padding:"0.5rem 0.75rem",fontSize:"0.85rem"},disabled:T||V<=0,children:"Total"})]})]}),e.jsxs(Ie,{children:[e.jsx(Ee,{htmlFor:"metodoPago",children:"Método de Pago"}),e.jsxs(Wt,{id:"metodoPago",value:C,onChange:c=>L(c.target.value),disabled:T,children:[e.jsx("option",{value:"Efectivo",children:"Efectivo"}),e.jsx("option",{value:"Tarjeta",children:"Tarjeta"}),e.jsx("option",{value:"Transferencia",children:"Transferencia"})]})]}),C!=="Efectivo"&&e.jsxs(Ie,{children:[e.jsx(Ee,{htmlFor:"referencia",children:"Referencia / Voucher / N° Transferencia"}),e.jsx(Re,{id:"referencia",type:"text",value:b,onChange:c=>s(c.target.value),placeholder:"Ej: BAC-123456",required:!0})]}),I&&e.jsx(Ht,{children:I}),e.jsx(Ye,{type:"submit",disabled:Z,children:T?e.jsxs(e.Fragment,{children:[e.jsx(Qe,{})," Procesando..."]}):e.jsxs(e.Fragment,{children:[e.jsx(gt,{})," Registrar Abono"]})})]})]})})},Jt=K.memo(Gt),Zt=yt`
  @media print {
...
`,G=t=>new Intl.NumberFormat("es-NI",{minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(t||0)),$=(...t)=>t.find(o=>o!=null),le=t=>$(t==null?void 0:t.usuarioNombre,t==null?void 0:t.nombre_usuario,t==null?void 0:t.nombre,t==null?void 0:t.name,t==null?void 0:t.displayName,t==null?void 0:t.fullName,t==null?void 0:t.username,null);function tn(t=[]){return t.map((o,x)=>{const f=Number($(o.quantity,o.cantidad,o.qty,0)),w=$(o.nombre,o.descripcion,o.description,o.producto,`Item ${x+1}`),u=Number($(o.precio_unitario,o.precio_venta,o.precio,o.unitPrice,0));return{id:$(o.id_producto,o.id,`it-${x}`),nombre:w,quantity:f,unit:u,total:f*u}})}function nn(t={}){const o=Number(t.efectivo||0),x=Number(t.tarjeta||0),f=Number(t.transferencia||0),w=Number(t.dolares||0);if(Number(t.credito||0)>0)return"Crédito";const d=[];return o>0&&d.push("Efectivo"),x>0&&d.push("Tarjeta"),f>0&&d.push("Transferencia"),w>0&&d.push("Dólares"),d.length===0?"Contado":d.length===1?d[0]:"Mixto"}function on(t={},o=0){const x=Number(t.efectivo||0),f=Number(t.tarjeta||0),w=Number(t.transferencia||0),u=Number(t.otro||0),d=Number(t.dolares||0),k=Number(t.tasaDolarAlMomento||t.tasaObtenida||1),C=d*(k>1?k:1),L=x+f+w+u+C;return L>0?L:Number(t.montoRecibido||o||0)}function rn(t){const o=$(t==null?void 0:t.fecha,t==null?void 0:t.createdAt,t==null?void 0:t.created_at,t==null?void 0:t.date,t);try{const x=new Date(o);return isNaN(x)?"Fecha inválida":x.toLocaleString("es-NI",{hour12:!0})}catch{return"Fecha inválida"}}function an(t){const o=$(t.proformaId,t.proformaNumero,t.numeroProforma,t.id);if(o)return o;const x=new Date,f=x.toISOString().slice(2,10).replace(/-/g,""),w=x.toTimeString().slice(0,8).replace(/:/g,"");return`PF-${f}-${w}`}const Dn=({transaction:t,onClose:o,clients:x=[],users:f=[],isOpen:w=!0,printMode:u="80",currentUser:d=null,onPersistPrint:k=null,autoTriggerPrint:C=!1,showAlert:L=null})=>{var xe;const{user:b}=typeof Me=="function"?Me():{user:null},{settings:s}=zt();if(!w||t==null)return null;const[T]=K.useState(typeof t=="object"?t:null),[E]=K.useState(!1),[I]=K.useState(null);if(E||I||!T)return e.jsx(Se,{className:"no-print",children:e.jsxs(tt,{className:"no-print",style:{maxWidth:420,padding:"1rem"},children:[e.jsx("h3",{style:{color:"#dc3545"},children:"No se pudo imprimir"}),e.jsx("div",{style:{display:"flex",justifyContent:"center",marginTop:12},children:e.jsxs(A,{onClick:o,$cancel:!0,children:[e.jsx(Le,{})," Cerrar"]})})]})});const a=T,S=a.estado==="ABONO_CREDITO",j=!!(a.isProforma||a.proformaFor||a.proformaNombre),M=!!a.isOutflow,m=a.estado==="DEVOLUCION",g=j?an(a):$(a.id,a.saleId,a.numero,"-"),X=rn($(a.fecha,a.createdAt,a.date)),V=$(a.clientId,a.idCliente,a.clienteId),D=x.find(h=>String(h.id_cliente??h.id)===String(V)),re=j&&a.proformaNombre?a.proformaNombre:$(D==null?void 0:D.nombre,a.clienteNombre,"Consumidor Final"),R=(D==null?void 0:D.cedula)||a.clienteCedula,ae=$(a.userId,a.idUsuario,(xe=a.openedBy)==null?void 0:xe.id)??(d==null?void 0:d.id_usuario)??(d==null?void 0:d.id)??(d==null?void 0:d.uid)??(b==null?void 0:b.id_usuario)??(b==null?void 0:b.id)??(b==null?void 0:b.uid),ee=(()=>{try{return JSON.parse(localStorage.getItem("authUser")||"null")}catch{return null}})(),F=f.find(h=>String(h.id_usuario||h.id||h.uid)===String(ae)),r=$(a.usuarioNombre,le(F),le(d),le(b),le(ee),"Cajero POS"),Z=j?$(a.usuarioNombre,le(d),le(b),le(ee),r):r,c=tn($(a.items,a.detalle,[])),v=c.reduce((h,W)=>h+Number(W.unit)*Number(W.quantity),0),_=Number($(a.subtotal,v)),z=Number($(a.descuento,0)),N=Number($(a.totalVenta,a.total_venta,_-z,0)),ce=a.pagoDetalles||{},te=j||M?"N/A":$(a.metodoPago,nn(ce)),U=j||M?0:on(ce,N),P=j||M?0:Math.max(0,U-N),ie=Math.abs(Number($(a.totalVenta,a.montoAbono,0))),Y=Number((D==null?void 0:D.saldo_pendiente)||0),be=Y+ie,je=c.length<=2,me=i.useMemo(()=>s!=null&&s.empresa_logo_url?s.empresa_logo_url.startsWith("http")?s.empresa_logo_url:`${"https://multirepuestosrg.com/api".replace(/\/api$/,"")}${s.empresa_logo_url.startsWith("/")?"":"/"}${s.empresa_logo_url}`:null,[s==null?void 0:s.empresa_logo_url]),O={name:(s==null?void 0:s.empresa_nombre)||"Multirepuestos RG",ruc:(s==null?void 0:s.empresa_ruc)||"1211812770001E",phone:(s==null?void 0:s.empresa_telefono)||"84031936 / 84058142",address:(s==null?void 0:s.empresa_direccion)||"Del portón de la normal 75 varas al este. Juigalpa, Chontales.",slogan:(s==null?void 0:s.empresa_eslogan)||"Repuestos de confianza al mejor precio",logo:me||new URL("/icons/logo.png",window.location.origin).toString()};K.useCallback(async h=>{},[]);const ne=K.useCallback((h="80",W=!1)=>{const fe=document.getElementById("print-wrapper-ticket");if(!fe)return;const Te=fe.outerHTML,pe=`
      @charset "UTF-8";
      @page { size: ${h==="A4"?"A4 portrait":"80mm auto"}; margin: ${h==="A4"?"12mm":"0"}; }
      html, body { background: #fff; margin: 0 !important; padding: 0 !important; font-family: ${h==="A4"?"'Inter', Helvetica, Arial, sans-serif":"'Consolas', monospace"}; color: #000 !important; }
      ...
      `}
    `,Q=window.open("","_blank","width=900,height=700");Q&&(Q.document.write(`<html><head><title>Impresión ${h.toUpperCase()} - ${O.name}</title><style>${pe}</style></head><body>${Te}</body></html>`),Q.document.close(),Q.focus(),setTimeout(()=>{try{Q.print()}catch(he){console.error("Print error:",he)}setTimeout(()=>{try{Q.close()}catch{}},1e3)},400),W&&setTimeout(()=>{o&&o()},800))},[O,o]),se=i.useRef(!1);return i.useEffect(()=>{if(C&&!se.current){se.current=!0;const h=setTimeout(()=>ne("80",!0),500);return()=>clearTimeout(h)}},[C,ne]),e.jsxs(Se,{className:"no-print",children:[e.jsx(Zt,{}),e.jsxs(tt,{className:"no-print",children:[e.jsxs(Xt,{children:[e.jsxs("h2",{style:{display:"flex",alignItems:"center",gap:8,margin:0},children:[e.jsx(bt,{color:"#2563eb"})," Vista de Impresión"]}),e.jsxs(en,{children:[e.jsxs(A,{onClick:()=>ne("80"),style:{background:"#2563eb",color:"#fff",fontWeight:700},children:[e.jsx(Pe,{})," 80mm"]}),e.jsxs(A,{onClick:()=>ne("A4"),style:{background:"#0f766e",color:"#fff",fontWeight:700},children:[e.jsx(jt,{})," A4"]}),e.jsx(A,{$cancel:!0,onClick:o,style:{background:"#fee2e2",color:"#ef4444"},children:e.jsx(Le,{})})]})]}),e.jsx(Qt,{children:e.jsxs(Yt,{id:"print-wrapper-ticket",className:`print-area ${u==="A4"?"print-a4":"print-80"} ${je?"compact":""}`,children:[e.jsxs("div",{className:"brand",children:[e.jsx("div",{className:"brand-logo-container",children:e.jsx(Kt,{className:u==="A4"?"logo-a4":"logo-80mm",src:O.logo,alt:"Logo",onError:h=>{h.currentTarget.style.display="none"}})}),e.jsxs("div",{className:"brand-info",children:[e.jsx("h1",{children:O.name}),e.jsx("small",{children:e.jsx("strong",{children:O.slogan})}),e.jsxs("small",{children:[e.jsx("strong",{children:"RUC:"})," ",O.ruc]}),e.jsxs("small",{children:[e.jsx("strong",{children:"Tel:"})," ",O.phone]}),e.jsx("small",{children:O.address}),e.jsx("div",{style:{marginTop:8},children:j?e.jsx(ue,{$type:"proforma",className:"ticket-tag",children:"PROFORMA"}):S?e.jsx(ue,{$type:"abono",className:"ticket-tag",children:"RECIBO"}):M?e.jsx(ue,{$type:"outflow",className:"ticket-tag",children:"SALIDA"}):a.isProReceipt||a.isWholesale?e.jsx(ue,{$type:"pro",className:"ticket-tag",children:"RECIBO PRO"}):e.jsx(ue,{$type:"venta",className:"ticket-tag",children:m?"DEVOLUCIÓN":"FACTURA"})})]})]}),e.jsxs("div",{className:"meta",children:[e.jsxs("div",{className:"meta-col",children:[e.jsx("span",{className:"meta-title",children:"Detalles del Documento"}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Fecha:"}),e.jsx("span",{className:"meta-value",children:X})]}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"No. Documento:"}),e.jsx("span",{className:"meta-value",children:g})]}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Atendido por:"}),e.jsx("span",{className:"meta-value",children:Z})]})]}),e.jsxs("div",{className:"meta-col",children:[e.jsx("span",{className:"meta-title",children:"Datos del Cliente"}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Cliente:"}),e.jsx("span",{className:"meta-value",children:re})]}),R&&e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Cédula/RUC:"}),e.jsx("span",{className:"meta-value",children:R})]}),!j&&!M&&e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Pago:"}),e.jsx("span",{className:"meta-value",children:te})]})]})]}),e.jsxs("table",{className:"items",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{className:"col-qty",children:"Cant."}),e.jsx("th",{children:"Descripción"}),e.jsx("th",{className:"text-right col-unit",children:"P. Unit"}),e.jsx("th",{className:"text-right col-total",children:"Total"})]})}),e.jsx("tbody",{children:c.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:"4",style:{textAlign:"center"},children:"Sin ítems"})}):c.map(h=>e.jsxs("tr",{children:[e.jsx("td",{className:"col-qty",style:{fontWeight:800},children:h.quantity}),e.jsx("td",{style:{fontWeight:600},children:h.nombre}),e.jsxs("td",{className:"text-right col-unit",children:["C$",G(h.unit)]}),e.jsxs("td",{className:"text-right col-total",style:{fontWeight:700},children:["C$",G(h.total)]})]},h.id))})]}),e.jsx("div",{className:"totals",children:e.jsx("div",{className:"totals-box",children:S?e.jsxs(e.Fragment,{children:[e.jsxs(q,{style:{marginTop:5,fontSize:"0.95em"},children:[e.jsx("span",{style:{fontWeight:700},children:"Saldo Anterior:"}),e.jsxs("span",{style:{fontWeight:700},children:["C$",G(be)]})]}),e.jsxs(q,{className:"grand-total",$bold:!0,style:{fontSize:"1.3em",borderTop:"2px solid #000",marginTop:5,paddingTop:5,color:"#28a745"},children:[e.jsx("span",{style:{fontWeight:900},children:"ABONÓ:"}),e.jsxs("span",{style:{fontWeight:900},children:["C$",G(ie)]})]}),e.jsxs(q,{$bold:!0,style:{fontSize:"1.1em",borderTop:"2px dashed #000",marginTop:5,paddingTop:5,color:Y>0?"#dc3545":"#28a745"},children:[e.jsx("span",{style:{fontWeight:900},children:"Saldo Pendiente:"}),e.jsxs("span",{style:{fontWeight:900},children:["C$",G(Y)]})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs(q,{children:[e.jsx("span",{style:{fontWeight:700},children:"Subtotal:"}),e.jsxs("span",{style:{fontWeight:700},children:["C$",G(_)]})]}),z>0&&e.jsxs(q,{style:{color:"#dc3545"},children:[e.jsx("span",{style:{fontWeight:700},children:"Descuento:"}),e.jsxs("span",{style:{fontWeight:700},children:["- C$",G(z)]})]}),e.jsxs(q,{className:"grand-total",$bold:!0,style:{fontSize:"1.3em",borderTop:"2px solid #000",marginTop:5,paddingTop:5},children:[e.jsx("span",{style:{fontWeight:900},children:"TOTAL:"}),e.jsxs("span",{style:{fontWeight:900},children:["C$",G(N)]})]}),!j&&e.jsxs(e.Fragment,{children:[e.jsxs(q,{style:{marginTop:10,fontSize:"0.9em"},children:[e.jsx("span",{style:{fontWeight:700},children:"Pagado:"}),e.jsxs("span",{style:{fontWeight:700},children:["C$",G(U)]})]}),P>0&&e.jsxs(q,{$bold:!0,style:{color:"#dc3545",fontWeight:900},children:[e.jsx("span",{children:"Cambio:"}),e.jsxs("span",{children:["C$",G(P)]})]})]})]})})}),e.jsxs("div",{className:"footer-sign no-show-80",children:[e.jsx("div",{className:"sign-box",children:"Entregado por"}),e.jsx("div",{className:"sign-box",children:"Recibido por"})]}),e.jsxs("div",{className:"thanks",children:[e.jsx("p",{children:e.jsxs("strong",{children:['"',O.slogan,'"']})}),e.jsx("p",{style:{whiteSpace:"pre-line",marginTop:"5px"},children:j?(s==null?void 0:s.ticket_proforma_footer)||"Cotización válida por 15 días.":M?(s==null?void 0:s.ticket_transfer_footer)||"Salida de Inventario.":(s==null?void 0:s.ticket_sales_footer)||"¡Gracias por su compra!"})]})]})})]})]})},J=t=>Number(t||0).toFixed(2),sn=(t,o=0)=>(t==null?void 0:t.nombre)??(t==null?void 0:t.name)??(t==null?void 0:t.producto)??(t==null?void 0:t.descripcion)??`Item ${o+1}`,nt=p.div`
...
`,cn=({sale:t,client:o,creditStatus:x,dailySales:f,isAdmin:w,onOpenAbonoModal:u,onCancelSale:d,onReturnItem:k,onReprintTicket:C,showConfirmation:L,showPrompt:b,showAlert:s})=>{var M;const T=i.useMemo(()=>!(!t||t.estado!=="COMPLETADA"),[t]);if(!t)return e.jsx(nt,{style:{justifyContent:"center",alignItems:"center"},children:e.jsxs(Ae,{children:[e.jsx(Ct,{})," Seleccione una transacción de la lista para ver sus detalles."]})});const I={COMPLETADA:{text:"COMPLETADA",color:"#28a745"},CANCELADA:{text:"CANCELADA",color:"#dc3545"},DEVOLUCION:{text:"DEVOLUCIÓN",color:"#ffc107"},ABONO_CREDITO:{text:"ABONO A CRÉDITO",color:"#17a2b8"}}[t.estado]||{text:t.estado,color:"#6c757d"},a=t.estado==="COMPLETADA",S=(m,g)=>{if(T){if(!k){s==null||s({title:"Config",message:"Falta onReturnItem en props.",type:"error"});return}k(m,g)}},j=()=>{if(T){if(!d){s==null||s({title:"Config",message:"Falta onCancelSale en props.",type:"error"});return}d(t)}};return e.jsxs(nt,{children:[e.jsxs("h3",{children:["Detalle de Transacción #",t.id]}),o&&x&&e.jsxs(Ae,{$type:"info",style:{flexDirection:"column",alignItems:"stretch",gap:"1rem"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("span",{style:{fontWeight:"bold"},children:["Estado de Cuenta: ",o.nombre]}),e.jsxs(A,{$primary:!0,onClick:u,disabled:x.currentBalance<=0,children:[e.jsx(Ue,{})," Registrar Abono"]})]}),e.jsxs(H,{$bold:!0,color:x.currentBalance>0?"#dc3545":"#28a745",children:[e.jsx("span",{children:"SALDO PENDIENTE TOTAL:"}),e.jsxs("span",{children:["C$",x.currentBalance.toFixed(2)]})]})]}),e.jsxs(Ne,{children:[e.jsxs("p",{children:[e.jsxs("strong",{children:[e.jsx(Ge,{})," Cliente:"]})," ",(o==null?void 0:o.nombre)||"Cliente Genérico"]}),e.jsxs("p",{children:[e.jsxs("strong",{children:[e.jsx(rt,{})," Fecha:"]})," ",new Date(t.fecha).toLocaleString("es-NI")]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("p",{style:{margin:0},children:[e.jsx("strong",{children:"Estado:"})," ",e.jsx(ot,{color:I.color,children:I.text})]}),(((M=t.pagoDetalles)==null?void 0:M.isWholesale)||t.isWholesale)&&e.jsx(ot,{color:"#8b5cf6",children:"VENTA MAYORISTA"})]})]}),a&&e.jsxs(e.Fragment,{children:[Array.isArray(t.items)&&t.items.length>0&&e.jsxs(Ne,{children:[e.jsx("h4",{children:"Productos"}),e.jsxs(ln,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Producto"}),e.jsx("th",{children:"Cant."}),e.jsx("th",{children:"P. Unit."}),e.jsx("th",{children:"Subtotal"}),e.jsx("th",{})]})}),e.jsx("tbody",{children:t.items.map((m,g)=>e.jsxs("tr",{children:[e.jsx("td",{children:sn(m,g)}),e.jsx("td",{children:(m==null?void 0:m.quantity)??(m==null?void 0:m.cantidad)??0}),e.jsxs("td",{children:["C$",J(m==null?void 0:m.precio)]}),e.jsxs("td",{children:["C$",J(((m==null?void 0:m.quantity)??(m==null?void 0:m.cantidad)??0)*((m==null?void 0:m.precio)??0))]}),e.jsx("td",{children:T&&e.jsx(A,{$warning:!0,$small:!0,onClick:()=>S(m,g),title:"Devolver",children:e.jsx(wt,{})})})]},(m&&(m.id_producto||m.id))??g))})]})]}),e.jsxs(Ne,{children:[e.jsx("h4",{children:"Resumen Financiero de esta Venta"}),t.subtotal!==void 0&&e.jsxs(H,{children:[e.jsx("span",{children:"Subtotal:"}),e.jsxs("span",{children:["C$",J(t.subtotal)]})]}),t.descuento>0&&e.jsxs(H,{children:[e.jsx("span",{children:"Descuento:"}),e.jsxs("span",{style:{color:"#dc3545"},children:["- C$",J(t.descuento)]})]}),e.jsxs(H,{$bold:!0,$bordered:!0,children:[e.jsx("span",{children:"Total Transacción:"}),e.jsxs("span",{children:["C$",J(Math.abs(t.totalVenta))]})]}),t.pagoDetalles&&e.jsxs("div",{style:{marginTop:"1rem"},children:[e.jsx("h5",{style:{marginBottom:"0.5rem",fontSize:"1rem"},children:"Detalle del Pago:"}),t.pagoDetalles.efectivo>0&&e.jsxs(H,{children:[e.jsxs("span",{children:[e.jsx(Ue,{})," Efectivo Recibido:"]}),e.jsxs("span",{children:["C$",J(t.pagoDetalles.efectivo)]})]}),t.pagoDetalles.tarjeta>0&&e.jsxs(e.Fragment,{children:[e.jsxs(H,{children:[e.jsxs("span",{children:[e.jsx(vt,{})," Tarjeta:"]}),e.jsxs("span",{children:["C$",J(t.pagoDetalles.tarjeta)]})]}),t.pagoDetalles.referenciaTarjeta&&e.jsxs(H,{style:{fontSize:"0.85rem",color:"#666",paddingLeft:"1.5rem"},children:[e.jsx("span",{children:"↳ Ref:"}),e.jsx("span",{children:t.pagoDetalles.referenciaTarjeta})]})]}),t.pagoDetalles.transferencia>0&&e.jsxs(e.Fragment,{children:[e.jsxs(H,{children:[e.jsxs("span",{children:[e.jsx(at,{})," Transferencia:"]}),e.jsxs("span",{children:["C$",J(t.pagoDetalles.transferencia)]})]}),t.pagoDetalles.referenciaTransferencia&&e.jsxs(H,{style:{fontSize:"0.85rem",color:"#666",paddingLeft:"1.5rem"},children:[e.jsx("span",{children:"↳ Ref:"}),e.jsx("span",{children:t.pagoDetalles.referenciaTransferencia})]})]}),t.pagoDetalles.credito>0&&e.jsxs(H,{children:[e.jsxs("span",{children:[e.jsx(Ge,{})," Crédito Otorgado:"]}),e.jsxs("span",{style:{color:"#dc3545"},children:["C$",J(t.pagoDetalles.credito)]})]}),t.pagoDetalles.vuelto>0&&e.jsxs(H,{children:[e.jsx("span",{children:"Vuelto Entregado:"}),e.jsxs("span",{children:["- C$",J(t.pagoDetalles.vuelto)]})]})]})]})]}),t.estado!=="CANCELADA"&&e.jsxs(Ne,{children:[e.jsx("h4",{children:"Acciones"}),e.jsxs(dn,{children:[e.jsxs(A,{onClick:C,children:[e.jsx(Pe,{})," Reimprimir Ticket"]}),T&&e.jsxs(A,{$cancel:!0,onClick:j,children:[e.jsx(Nt,{})," Cancelar Venta"]})]})]})]})},pn=K.memo(cn),Fe=()=>{const t=new Date,o=t.toLocaleString("en-US",{year:"numeric",timeZone:"America/Managua"}),x=t.toLocaleString("en-US",{month:"2-digit",timeZone:"America/Managua"}),f=t.toLocaleString("en-US",{day:"2-digit",timeZone:"America/Managua"});return`${o}-${x}-${f}`},_e=t=>new Intl.NumberFormat("es-NI",{minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(t||0)),mn=t=>{if(!t)return{label:"N/A",icon:null};const{efectivo:o,tarjeta:x,transferencia:f,credito:w}=t;if(Number(w)>0)return{label:"Crédito",icon:e.jsx(Ze,{style:{color:"#dc3545"}})};const u=[];if(Number(o)>0&&u.push("Efectivo"),Number(x)>0&&u.push("Tarjeta"),Number(f)>0&&u.push("Transferencia"),u.length===1){const d=u[0];return d==="Efectivo"?{label:"Efectivo",icon:e.jsx(De,{style:{color:"#28a745"}})}:d==="Tarjeta"?{label:"Tarjeta",icon:e.jsx(Ze,{style:{color:"#007bff"}})}:{label:"Transferencia",icon:e.jsx(at,{style:{color:"#007bff"}})}}return u.length>1?{label:"Mixto",icon:e.jsx(De,{style:{color:"#ffc107"}})}:{label:"Contado",icon:e.jsx(De,{style:{color:"#28a745"}})}},ke=(t,o=0)=>(t==null?void 0:t.nombre)??(t==null?void 0:t.name)??(t==null?void 0:t.producto)??(t==null?void 0:t.descripcion)??`Item ${o+1}`,xn=p(Oe)`
  width: 95%;
  max-width: 1400px;
  height: 90vh;
  display: flex;
...
`,wn=K.memo(function({sale:o,isSelected:x,onSelect:f,safeUsers:w,safeClients:u}){var E;const d={COMPLETADA:"#28a745",CANCELADA:"#dc3545",DEVOLUCION:"#ffc107",ABONO_CREDITO:"#17a2b8"},k=i.useMemo(()=>{var a,S;return((a=(w||[]).find(j=>((j==null?void 0:j.id_usuario)??(j==null?void 0:j.id))==(o==null?void 0:o.userId)))==null?void 0:a.nombre_usuario)||((S=o==null?void 0:o.usuario)==null?void 0:S.nombre_usuario)||(o==null?void 0:o.userName)||(o==null?void 0:o.vendedor)||"N/A"},[w,o]),C=i.useMemo(()=>{var a,S;return((a=(u||[]).find(j=>(j==null?void 0:j.id_cliente)===((o==null?void 0:o.clientId)||(o==null?void 0:o.idCliente))))==null?void 0:a.nombre)||((S=o==null?void 0:o.cliente)==null?void 0:S.nombre)||(o==null?void 0:o.clientName)||"Consumidor Final"},[u,o]),L=Number(o.totalVenta??o.total_venta??o.total??0),b=mn(o.pagoDetalles),s=o.estado==="ABONO_CREDITO"?e.jsxs(e.Fragment,{children:[e.jsx(it,{style:{marginRight:6}})," ABONO"]}):e.jsxs(e.Fragment,{children:["#",o.id," - ",o.estado.replace("_"," ")]}),T=((E=o.pagoDetalles)==null?void 0:E.isWholesale)||o.isWholesale;return e.jsxs(Cn,{onClick:()=>f(o),selected:x,$borderColor:d[o.estado]||"#6c757d",title:`Venta #${o.id}`,children:[e.jsxs("div",{className:"top",children:[e.jsx("span",{children:s}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[T&&e.jsx(st,{style:{background:"#8b5cf6",color:"white",fontSize:"0.7rem"},children:"MAYORISTA"}),e.jsxs("span",{children:[b.icon," C$",_e(Math.abs(L))]})]})]}),e.jsxs("div",{className:"sub",children:[new Date(o.fecha).toLocaleString("es-NI")," · Cliente: ",e.jsx("strong",{children:C})," · Vendedor: ",k]})]})}),ze=10;function vn({dailySales:t=[],loadSales:o,onClose:x,isAdmin:f,users:w=[],clients:u=[],onReprintTicket:d,onCancelSale:k,onReturnItem:C,onAbonoSuccess:L,initialClientId:b=null}){var Ve,Be,We,qe;const[s,T]=i.useState(Fe()),[E,I]=i.useState(Fe()),[a,S]=i.useState(Array.isArray(t)?t:[]),[j,M]=i.useState(!1),[m,g]=i.useState(""),[X,V]=i.useState(""),[D,re]=i.useState(""),[R,ae]=i.useState(1),ee=i.useMemo(()=>Array.isArray(w)?w:[],[w]),F=i.useMemo(()=>Array.isArray(u)?u:[],[u]);i.useEffect(()=>{if(b){const n=F.find(l=>l.id_cliente===b);n?(g(n.nombre),I("")):g(String(b))}},[b,F]);const[r,Z]=i.useState(null),[c,v]=i.useState(!1),[_,z]=i.useState({open:!1,title:"",message:""}),N=(n,l)=>z({open:!0,title:n,message:l}),ce=()=>z({open:!1,title:"",message:""}),[te,U]=i.useState({open:!1,title:"",message:"",onConfirm:null}),P=(n,l,y)=>U({open:!0,title:n,message:l,onConfirm:y}),ie=()=>U({open:!1,title:"",message:"",onConfirm:null}),[Y,be]=i.useState({open:!1,title:"",message:"",initialValue:"1",onConfirm:null}),je=(n,l,y,B)=>be({open:!0,title:n,message:l,initialValue:String(y??"1"),onConfirm:B}),me=()=>be({open:!1,title:"",message:"",initialValue:"1",onConfirm:null}),O=i.useCallback(async(n=null)=>{if(!o)return[];M(!0),T(n);try{const l=await o(n),y=Array.isArray(l)?l:[];return S(y),y}catch(l){return S([]),N("Error","No se pudieron cargar las transacciones: "+(l.message||"Error de conexión.")),[]}finally{M(!1)}},[o]);i.useEffect(()=>{const l=m&&m.length>=2||b&&!E?null:E;O(l),ae(1),Z(null)},[E,O,m,b]),i.useEffect(()=>{E===Fe()&&Array.isArray(t)&&!m&&S(t)},[t,E,m]);const ne=i.useMemo(()=>{const n=(m||"").toLowerCase();return(a||[]).filter(y=>{var ye;const B=y.clientId||y.idCliente,oe=((ye=F.find(Ce=>Ce.id_cliente===B))==null?void 0:ye.nombre)||"";return(!X||String(y.userId)===String(X))&&(!D||y.estado===D)&&(!n||String(y.id).includes(n)||oe.toLowerCase().includes(n))}).sort((y,B)=>new Date(B.fecha)-new Date(y.fecha))},[a,X,D,m,F]),se=Math.max(1,Math.ceil(ne.length/ze)),xe=(R-1)*ze,h=ne.slice(xe,xe+ze);i.useEffect(()=>{(!r||!h.some(n=>n.id===r.id))&&Z(h[0]||null)},[h,r]);const W=i.useCallback(async(n=null)=>{const l=await O(s);if(n){const y=(l||[]).find(B=>String(B.id)===String(n));Z(y||null)}else Z(null)},[O,s]),fe=i.useCallback(n=>{const l=typeof n=="object"&&(n!=null&&n.id)?n.id:n||(r==null?void 0:r.id),y=typeof n=="object"&&n?n:r;if(!(!l||!y)){if(y.estado==="CANCELADA"){N("Venta ya cancelada",`La venta #${l} ya fue cancelada.`);return}if(!k){N("Error de Configuración","onCancelSale no fue proporcionada.");return}P("Cancelar Venta",`¿Seguro que deseas cancelar la venta #${l}? Esta acción revierte inventario y no se puede deshacer.`,async()=>{ie();try{await k(y),N("Éxito",`Venta #${l} cancelada.`),await W(null)}catch(B){N("Error al Cancelar",B.message||"No se pudo cancelar la venta.")}})}},[r,k,W]),Te=i.useCallback((n,l=0)=>{if(!r)return;if(!C){N("Error de Configuración","onReturnItem no fue proporcionada.");return}const y=Number((n==null?void 0:n.quantity)||(n==null?void 0:n.cantidad)||0);if(!Number.isFinite(y)||y<=0){N("No se puede devolver","Este artículo no tiene cantidad disponible para devolver.");return}je("Devolver producto",`Cantidad a devolver para "${ke(n,l)}" (máx. ${y})`,"1",async B=>{const oe=Number(B);if(!Number.isFinite(oe)||oe<=0||oe>y){N("Cantidad inválida",`Ingresa un número entre 1 y ${y}.`);return}const ye=r.items.length===1&&oe===y,Ce=async()=>{try{await C(r,n,oe),N("Éxito",`Se devolvieron ${oe} unidad(es) de ${ke(n,l)}.`),await W(null)}catch(we){const He=((we==null?void 0:we.message)||"").toLowerCase(),mt=He.includes("not found")||He.includes("404")?"Ruta de API no encontrada.":we.message||"No se pudo devolver el producto.";N("Error al Devolver",mt)}};if(ye){me(),setTimeout(()=>{U({open:!0,title:"¿Cancelar Venta Completa?",message:`Este es el ÚLTIMO artículo de la venta. 

¿Prefieres CANCELAR toda la venta en lugar de hacer una devolución individual?
(Esto revertirá todo el ticket).`,onConfirm:async()=>{U({open:!1,title:"",message:"",onConfirm:null}),k&&fe(r.id)},onClose:()=>{U({open:!1,title:"",message:"",onConfirm:null}),Ce()}})},100);return}await Ce()})},[r,C,W]),pe=i.useCallback(()=>{r&&(d==null||d(r))},[r,d]),[Q,he]=i.useState(!1),dt=i.useCallback(async()=>{if(!r||r.estado!=="ABONO_CREDITO")return;const n=r.clientId||r.idCliente;if(!n){N("Error","No se pudo identificar el cliente.");return}P("Cancelar Abono",`¿Estás seguro de cancelar este abono #${r.id}? Se restaurará el saldo del cliente.`,async()=>{ie(),he(!0);try{const l=localStorage.getItem("token");await Lt(n,r.id,l),It.success("Abono cancelado exitosamente."),await W(null)}catch(l){N("Error",l.message||"No se pudo cancelar el abono.")}finally{he(!1)}})},[r,W]),ct=ne.length,pt=h.length;return e.jsxs(Se,{"data-history-modal":!0,children:[e.jsxs(xn,{children:[e.jsxs(fn,{children:[e.jsxs("h2",{children:[e.jsx(Je,{})," Historial de Transacciones"]}),e.jsx(A,{$cancel:!0,onClick:x,children:e.jsx(Le,{})})]}),e.jsxs(hn,{children:[e.jsxs("div",{children:[e.jsxs("label",{children:[e.jsx(kt,{})," Buscar ID/Cliente:"]}),e.jsx(ve,{type:"text",placeholder:"ID o nombre",value:m,onChange:n=>g(n.target.value)})]}),e.jsxs("div",{children:[e.jsxs("label",{children:[e.jsx(rt,{})," Fecha:"]}),e.jsx(ve,{type:"date",value:E,onChange:n=>I(n.target.value)})]}),f&&e.jsxs("div",{children:[e.jsxs("label",{children:[e.jsx($t,{})," Usuario:"]}),e.jsxs(ve,{as:"select",value:X,onChange:n=>V(n.target.value),children:[e.jsx("option",{value:"",children:"Todos"}),ee.map(n=>e.jsx("option",{value:n.id_usuario??n.id,children:n.nombre_usuario??n.nombre},n.id_usuario??n.id))]})]}),e.jsxs("div",{children:[e.jsxs("label",{children:[e.jsx(St,{})," Estado:"]}),e.jsxs(ve,{as:"select",value:D,onChange:n=>re(n.target.value),children:[e.jsx("option",{value:"",children:"Todos"}),e.jsx("option",{value:"COMPLETADA",children:"Completadas"}),e.jsx("option",{value:"CANCELADA",children:"Canceladas"}),e.jsx("option",{value:"DEVOLUCION",children:"Devoluciones"}),e.jsx("option",{value:"ABONO_CREDITO",children:"Abonos"})]})]})]}),e.jsxs(gn,{children:[e.jsxs(un,{children:[e.jsxs(bn,{children:[e.jsx("small",{children:m?e.jsx("strong",{children:"Mostrando historial de búsqueda"}):`Resultados: ${ct}`}),e.jsxs(st,{$green:!0,children:["Mostrando ",pt]})]}),j&&e.jsx(Ae,{style:{textAlign:"center",margin:".5rem 0"},children:"Cargando transacciones…"}),!j&&e.jsx(jn,{children:h.length?h.map(n=>e.jsx(wn,{sale:n,isSelected:(r==null?void 0:r.id)===n.id,onSelect:Z,safeUsers:ee,safeClients:F},n.id)):e.jsx("p",{style:{textAlign:"center",color:"#6c757d",marginTop:"1rem"},children:"No se encontraron transacciones para la fecha y filtros seleccionados."})}),se>1&&e.jsxs(yn,{children:[e.jsx(A,{onClick:()=>ae(n=>Math.max(1,n-1)),disabled:R===1,title:"Anterior",children:e.jsx(At,{})}),e.jsxs("span",{children:["Página ",R," de ",se]}),e.jsx(A,{onClick:()=>ae(n=>Math.min(se,n+1)),disabled:R===se,title:"Siguiente",children:e.jsx(Tt,{})})]})]}),r?r.estado==="ABONO_CREDITO"?e.jsxs($e,{children:[e.jsxs("div",{style:{borderBottom:"2px dashed #ccc",paddingBottom:15,marginBottom:15},children:[e.jsxs("h3",{style:{margin:0,fontSize:"1.4rem",color:"#17a2b8",textAlign:"center"},children:[e.jsx(it,{})," Recibo de Abono"]}),e.jsxs("p",{style:{textAlign:"center",color:"#555",margin:"5px 0"},children:["#",r.id]})]}),e.jsx(Ae,{children:e.jsxs("div",{style:{display:"grid",gap:10},children:[e.jsxs(q,{children:[e.jsx("span",{children:"Fecha:"}),e.jsx("strong",{children:new Date(r.fecha).toLocaleString("es-NI")})]}),e.jsxs(q,{children:[e.jsx("span",{children:"Cliente:"}),e.jsx("strong",{style:{fontSize:"1.1rem"},children:((Ve=F.find(n=>n.id_cliente===(r.clientId||r.idCliente)))==null?void 0:Ve.nombre)||"Desconocido"})]}),e.jsxs(q,{children:[e.jsx("span",{children:"Cajero:"}),e.jsx("strong",{children:((Be=ee.find(n=>(n.id_usuario??n.id)==r.userId))==null?void 0:Be.nombre_usuario)||r.usuarioNombre||"Sistema"})]})]})}),e.jsx("div",{style:{margin:"20px 0",border:"1px solid #ddd",padding:15,borderRadius:8,background:"#f8f9fa"},children:e.jsxs(q,{style:{fontSize:"1.2rem",color:"#28a745"},children:[e.jsx("span",{children:"Monto Abonado:"}),e.jsxs("strong",{children:["C$ ",_e(r.totalVenta)]})]})}),e.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"12px",marginTop:20},children:[e.jsxs(A,{onClick:pe,style:{fontSize:"1.1rem",padding:"10px 20px"},children:[e.jsx(Pe,{})," Imprimir Comprobante"]}),e.jsxs(A,{onClick:dt,disabled:Q,style:{fontSize:"1rem",padding:"10px 20px",background:"#dc3545",color:"white",border:"none",fontWeight:700},children:[e.jsx(Dt,{})," ",Q?"Cancelando...":"Cancelar Abono"]})]})]}):r.estado==="DEVOLUCION"?e.jsxs($e,{children:[e.jsxs("h3",{style:{marginTop:0},children:["Detalle de Transacción #",r.id]}),e.jsxs("div",{className:"box",style:{marginTop:10},children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Cliente:"})," ",((We=F.find(n=>n.id_cliente===(r.clientId||r.idCliente)))==null?void 0:We.nombre)||"Consumidor Final"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Fecha:"})," ",new Date(r.fecha).toLocaleString("es-NI")]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Estado:"})," ",e.jsx("span",{style:{background:"#fff3cd",color:"#856404",padding:"2px 8px",borderRadius:8,fontWeight:700},children:"DEVOLUCIÓN"})]})]}),e.jsxs("div",{className:"box",style:{marginTop:10},children:[e.jsx("h4",{style:{marginTop:0},children:"Detalle de Devolución"}),e.jsx("ul",{style:{margin:0,paddingLeft:18},children:(r.items||[]).map((n,l)=>e.jsxs("li",{children:[e.jsx("strong",{children:ke(n,l)})," ","— ",Number(n.quantity||n.cantidad||0)," u. @ C$",Number(n.precio||n.precio_unitario||0).toFixed(2)]},`${n.id||n.id_producto}-${l}`))}),e.jsxs("p",{style:{marginTop:8},children:["Importe devuelto:"," ",e.jsxs("strong",{children:["C$",(()=>{const n=Number(r.totalVenta??r.total_venta??r.total??0);return Math.abs(n).toFixed(2)})()]})]})]}),e.jsx("div",{style:{display:"flex",justifyContent:"flex-start",gap:10,marginTop:12},children:e.jsx(A,{onClick:pe,children:"Reimprimir Ticket"})})]}):r.estado==="CANCELADA"?e.jsxs($e,{children:[e.jsxs("h3",{style:{marginTop:0,color:"#dc3545"},children:["Detalle de Venta Cancelada #",r.id]}),e.jsxs("div",{className:"box",style:{marginTop:10},children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Cliente:"})," ",((qe=F.find(n=>n.id_cliente===(r.clientId||r.idCliente)))==null?void 0:qe.nombre)||"Consumidor Final"]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Fecha:"})," ",new Date(r.fecha).toLocaleString("es-NI")]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Estado:"})," ",e.jsx("span",{style:{background:"#f8d7da",color:"#721c24",padding:"2px 8px",borderRadius:8,fontWeight:700},children:"CANCELADA"})]})]}),e.jsxs("div",{className:"box",style:{marginTop:10},children:[e.jsx("h4",{style:{marginTop:0},children:"Productos Cancelados"}),!r.items||r.items.length===0?e.jsx("p",{style:{color:"#6c757d",fontStyle:"italic"},children:"No hay detalles de productos disponibles."}):e.jsx("ul",{style:{margin:0,paddingLeft:18,color:"#6c757d"},children:r.items.map((n,l)=>e.jsxs("li",{children:[e.jsx("strong",{children:ke(n,l)})," ","— ",Number(n.quantity||n.cantidad||0)," u."]},`${n.id||n.id_producto}-${l}`))}),e.jsxs("p",{style:{marginTop:8,color:"#dc3545",textDecoration:"line-through"},children:["Total Anulado: ",e.jsxs("strong",{children:["C$ ",_e(r.totalVenta)]})]})]}),e.jsx("div",{style:{display:"flex",justifyContent:"flex-start",gap:10,marginTop:12},children:e.jsx(A,{onClick:pe,children:"Reimprimir Comprobante"})})]}):e.jsx(pn,{sale:r,client:F.find(n=>n.id_cliente===(r.clientId||r.idCliente)),creditStatus:null,dailySales:a,isAdmin:f,onOpenAbonoModal:()=>v(!0),onCancelSale:n=>fe(n),onReturnItem:(n,l)=>Te(n,l),onReprintTicket:pe,showConfirmation:({onConfirm:n})=>P("Confirmación","¿Confirmar acción?",n),showPrompt:({title:n,message:l,defaultValue:y,onConfirm:B})=>je(n,l,y,B),showAlert:({title:n,message:l})=>N(n,l)}):e.jsx($e,{children:e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",color:"#aaa",fontStyle:"italic",flexDirection:"column"},children:[e.jsx(Je,{size:40,style:{marginBottom:10,opacity:.5}}),e.jsx("p",{children:"Seleccione una transacción para ver detalles"})]})})]}),c&&r&&e.jsx(Jt,{client:F.find(n=>n.id_cliente===(r.clientId||r.idCliente)),onClose:()=>v(!1),onAbonoSuccess:async()=>{v(!1),await W(r.id),L==null||L()},showAlert:({title:n,message:l})=>N(n,l)})]}),e.jsx(Mt,{isOpen:_.open,onClose:ce,title:_.title,message:_.message}),e.jsx(Nn,{isOpen:!!te.open,title:te.title,message:te.message,onCancel:ie,onConfirm:te.onConfirm||ie}),e.jsx(kn,{isOpen:!!Y.open,title:Y.title,message:Y.message,initialValue:Y.initialValue,onCancel:me,onConfirm:n=>{const l=Y.onConfirm;me(),l&&l(n)}})]})}const lt=({isOpen:t,children:o,maxWidth:x=450})=>t?e.jsx(Se,{style:{zIndex:99999,backgroundColor:"rgba(0,0,0,0.6)"},children:e.jsx(Oe,{style:{maxWidth:`${x}px`,textAlign:"center"},children:o})}):null,Nn=({isOpen:t,title:o,message:x,onCancel:f,onConfirm:w})=>e.jsxs(lt,{isOpen:t,children:[e.jsx("h2",{style:{marginTop:0},children:o}),e.jsx("p",{style:{color:"#6c757d",lineHeight:1.5},children:x}),e.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:10,marginTop:10},children:[e.jsx(A,{onClick:f,$cancel:!0,children:"Cancelar"}),e.jsx(A,{onClick:w,primary:!0,children:"Aceptar"})]})]}),kn=({isOpen:t,title:o,message:x,initialValue:f="1",inputType:w="number",onCancel:u,onConfirm:d})=>{const[k,C]=i.useState(f);return i.useEffect(()=>{C(f)},[f,t]),e.jsxs(lt,{isOpen:t,children:[e.jsx("h2",{style:{marginTop:0},children:o}),x&&e.jsx("p",{style:{color:"#6c757d"},children:x}),e.jsx("input",{style:{width:"100%",padding:".6rem",borderRadius:8,border:"1px solid #dee2e6",margin:"8px 0 14px"},type:w,value:k,onChange:L=>C(L.target.value)}),e.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:10},children:[e.jsx(A,{onClick:u,$cancel:!0,children:"Cancelar"}),e.jsx(A,{onClick:()=>d(k),primary:!0,children:"Aceptar"})]})]})},In=K.memo(vn);export{Jt as A,In as S,Dn as T};
