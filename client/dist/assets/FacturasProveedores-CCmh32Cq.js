import{r as n,j as e,I as V,X as Ge,Y as qe,aP as Z,aQ as $,ah as P,ag as _,aa as oe,aR as K,$ as Ye,aS as Xe,aN as Je,aT as Qe,am as ee,k as G,a as Ue,s as l,ae as re,t as Ne,V as Ze}from"./vendor-C4uQ3a2a.js";import{u as Ke,I as er,A as rr,J as tr,K as ar,L as or,M as sr,N as nr,O as ir}from"./index-DrTQe3aZ.js";import{r as lr}from"./searchEngine-BMYcElFi.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-BMvqz6Um.js";const ye=()=>new Date().toLocaleDateString("sv-SE",{timeZone:"America/Managua"}),S=a=>{if(!a)return"—";const f=new Date(a.includes("T")?a:`${a}T12:00:00`);return new Intl.DateTimeFormat("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}).format(f)},se=Ne`from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); }`,dr=Ne`from { transform: scale(0.95); opacity: 0; } to { transform: scale(1); opacity: 1; }`,cr=l.div`
