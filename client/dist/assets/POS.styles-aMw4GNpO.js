...
`,C=r.div`
  ...
  .product-name {
    font-weight: 600; font-size: 0.88rem; color: ${a}; line-height: 1.3;
...
`,B=r.button`
  ...
  ${e=>e.secondary&&i`
    background: rgba(255, 255, 255, 0.8); color: ${a}; border: ${t};
...
`,_=r(c)`
  ...
  transition: all 0.2s;
  &:hover { color: ${a}; background: rgba(0,0,0,0.04); }
`,A=r.div`
...
`;export{m as A,B,v as C,g as H,R as I,M,I as N,Y as O,u as P,O as Q,P as R,T as S,S as T,H as a,_ as b,k as c,y as d,A as e,E as f,$ as g,h,w as i,z as j,C as k,j as l};
