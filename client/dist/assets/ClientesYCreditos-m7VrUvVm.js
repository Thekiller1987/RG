import{r as s,j as e,n as ne,D as ie,s as a,ad as V,x as se,R as le,ae as J,q as de,E as F,I as Y,af as L,ag as ce,a8 as pe,ah as me,v as xe,ai as he,V as ge,aj as fe,U as ue,a4 as Z,X,ak as K,al as B,S as be}from"./vendor-j_myMsPa.js";import{e as je,h as ye,a as we,u as ae,i as Ce,j as ve,k as ke,m as Se,n as Ne,o as $e,p as Ae,q as ze}from"./index-8T-9wPBW.js";import{T as oe,A as Te,S as De}from"./SalesHistoryModal-t8pl8oGd.js";import{M as Ie,a as _e,B as R}from"./POS.styles-edu8PlKE.js";import{A as Ee}from"./AlertModal-D8LdRFUA.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-CJwN73Oo.js";const Fe=a.div`
...
`,tt=a(xe)`animation: spin 1s linear infinite; @keyframes spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }`,q=a.div`text-align: center; padding: 2rem; color: #6c757d;`,nt=a.div`
...
`;function Tt(){var M;const{clients:t,user:y,token:c,isLoading:i,refreshClients:p,allUsers:b}=ae(),{isCajaOpen:h,cajaSession:w,setCajaSession:$,refreshSession:m}=$e(),[x,r]=s.useState({name:null,data:null}),[C,l]=s.useState(null),[f,A]=s.useState({open:!1,title:"",message:""}),v=s.useCallback(({title:n,message:S})=>{A({open:!0,title:n||"Aviso",message:S||""})},[]),P=s.useCallback(()=>{A({open:!1,title:"",message:""})},[]),I=async n=>{if(n.saldo_pendiente>0){B.error("El cliente tiene saldo pendiente.");return}if(window.confirm("¿Seguro de eliminar este cliente?"))try{await ze(n.id_cliente,c),B.success("Cliente eliminado correctamente."),p()}catch(S){B.error(S.message||"Error al eliminar cliente.")}},k=(n,S=null)=>r({name:n,data:S}),z=()=>r({name:null,data:null}),_=n=>`C$${Number(n||0).toFixed(2)}`,O=n=>n===null?"∞":_(n);return i?e.jsx(Q,{children:e.jsx("h1",{children:"Cargando..."})}):e.jsxs(Q,{children:[e.jsxs(mt,{children:[e.jsxs(xt,{children:[e.jsx(he,{})," Clientes y Créditos"]}),e.jsxs(ee,{children:[e.jsxs(N,{primary:!0,onClick:()=>k("client"),children:[e.jsx(ge,{})," Crear Cliente"]}),e.jsxs(N,{$refresh:!0,onClick:p,children:[e.jsx(fe,{})," Recargar"]}),e.jsxs(ht,{to:"/dashboard",children:[e.jsx(ue,{})," Volver"]})]})]}),e.jsxs(gt,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"ID"}),e.jsx("th",{children:"Nombre"}),e.jsx("th",{children:"Teléfono"}),e.jsx("th",{children:"Límite"}),e.jsxs("th",{children:[e.jsx(Y,{})," Saldo"]}),e.jsx("th",{children:"Acciones"})]})}),e.jsx("tbody",{children:t.map(n=>e.jsxs("tr",{children:[e.jsx("td",{children:n.id_cliente}),e.jsx("td",{children:n.nombre}),e.jsx("td",{children:n.telefono||"N/A"}),e.jsx("td",{children:O(n.limite_credito)}),e.jsx("td",{style:{fontWeight:"bold",color:n.saldo_pendiente>0?"#dc3545":"#28a745"},children:_(n.saldo_pendiente)}),e.jsx("td",{children:e.jsxs(ee,{children:[e.jsx(N,{$abono:!0,disabled:!h||n.saldo_pendiente<=0,onClick:()=>k("abono",n),title:"Realizar Abono",children:e.jsx(L,{})}),e.jsx(N,{onClick:()=>k("client",n),title:"Editar Cliente",children:e.jsx(Z,{})}),e.jsx(N,{primary:!0,onClick:()=>k("historial",n),title:"Ver Historial",children:e.jsx(X,{})}),e.jsx(N,{$refresh:!0,style:{background:"#6f42c1"},onClick:()=>k("tickets",n),title:"Ver Tickets",children:e.jsx(L,{})}),e.jsx(N,{$delete:!0,onClick:()=>I(n),title:"Eliminar Cliente",children:e.jsx(K,{})})]})})]},n.id_cliente))})]}),e.jsx(ft,{children:t.map(n=>e.jsxs(ut,{children:[e.jsxs(bt,{children:[e.jsxs("div",{children:[e.jsx(jt,{children:n.nombre}),e.jsxs(yt,{children:["ID: ",n.id_cliente," • ",n.telefono||"Sin Teléfono"]})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"flex-end"},children:[e.jsx("span",{style:{fontSize:"0.75rem",color:"#adb5bd",fontWeight:"600"},children:"SALDO"}),e.jsx("span",{style:{fontSize:"1.2rem",fontWeight:"bold",color:n.saldo_pendiente>0?"#dc3545":"#28a745"},children:_(n.saldo_pendiente)})]})]}),e.jsxs(wt,{children:[e.jsxs(te,{children:[e.jsx("span",{className:"label",children:"Límite Crédito"}),e.jsx("span",{className:"value",children:O(n.limite_credito)})]}),e.jsxs(te,{children:[e.jsx("span",{className:"label",children:"Estado"}),e.jsx("span",{className:"value",style:{color:n.saldo_pendiente>0?"#e03131":"#2f9e44"},children:n.saldo_pendiente>0?"Con Deuda":"Al Día"})]})]}),e.jsxs(Ct,{children:[e.jsxs(N,{$abono:!0,disabled:!h||n.saldo_pendiente<=0,onClick:()=>k("abono",n),children:[e.jsx(L,{})," Abonar"]}),e.jsxs(N,{onClick:()=>k("client",n),children:[e.jsx(Z,{})," Editar"]}),e.jsxs(N,{primary:!0,onClick:()=>k("historial",n),children:[e.jsx(X,{})," Historial"]}),e.jsxs(N,{$refresh:!0,style:{background:"#6f42c1"},onClick:()=>k("tickets",n),children:[e.jsx(L,{})," Tickets"]}),e.jsxs(N,{$delete:!0,style:{gridColumn:"span 2"},onClick:()=>I(n),children:[e.jsx(K,{})," Eliminar Cliente"]})]})]},n.id_cliente))}),x.name==="client"&&e.jsx(He,{client:x.data,onClose:z,onSave:p}),x.name==="abono"&&e.jsx(Te,{client:x.data,onClose:z,onAbonoSuccess:()=>{p(),m(),B.success("Abono registrado correctamente.")},showAlert:v}),x.name==="historial"&&e.jsx(pt,{client:x.data,onClose:z,token:c}),x.name==="tickets"&&e.jsx(De,{onClose:z,initialClientId:(M=x.data)==null?void 0:M.id_cliente,clients:t,users:b,loadSales:async n=>{try{return await Ae(c,n)}catch(S){return console.error(S),[]}},onReprintTicket:n=>{l(n)}}),C&&e.jsx(oe,{isOpen:!0,transaction:C,onClose:()=>l(null),clients:t,users:b,currentUser:y}),f.open&&e.jsx(Ee,{title:f.title,message:f.message,onClose:P})]})}export{Tt as default};
