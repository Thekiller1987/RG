import{r as l,j as e,a0 as _e,a1 as Ve,aS as qe,A as Re,m as $e,H as Ge,s as se,a6 as He,a7 as Ue,k as Je,b as Ye,R as ke,aO as Ke,b2 as We,af as Le,b4 as Qe,J as Ie,x as Te,b5 as Xe,b6 as Ze,aV as et,ag as tt,b7 as at,a3 as ot,b8 as Fe,b9 as rt,ba as nt,aa as it,aT as st,C as Me,q as lt,bb as dt,bc as ct,bd as pt}from"./vendor-C4uQ3a2a.js";import{g as ge,s as he,f as Pe,u as De,a as mt}from"./index-DrTQe3aZ.js";import{r as xt}from"./searchEngine-BMYcElFi.js";import{d as ft,S as O,h as gt,i as ht,j as bt,M as be,a as je,B as R,f as J,I as Ae}from"./POS.styles-yJMpH_iU.js";import"./AlertModal-Chz8o6FH.js";const w=o=>{const f=Number(o);return isNaN(f)||!isFinite(f)?0:f};function ut(o){if(!Array.isArray(o)||o.length===0)return[];const f=new Set,a=[];for(const b of o)b.id&&f.has(b.id)||(b.id&&f.add(b.id),a.push(b));return a}const jt=(o,f=0,a=36.6)=>{const b=Math.max(0,w(f)),S=w(a)||36.6,p={ventasContado:[],devoluciones:[],cancelaciones:[],entradas:[],salidas:[],abonos:[],ajustes:[]};let n=0,r=0,u=0,c=0,I=0,T=0,F=0,m=0;const E=ut(Array.isArray(o)?o:[]);let t=0,x=0,j=0,v=0,K=0,$=0,s=0,P=0,V=0;for(const M of E){let g=((M==null?void 0:M.type)||"").toLowerCase().trim();g=g.normalize("NFD").replace(/[\u0300-\u036f]/g,"");let C=(M==null?void 0:M.pagoDetalles)||{};if(typeof C=="string")try{C=JSON.parse(C)}catch{C={}}(!C||typeof C!="object")&&(C={});const D=w(M.amount),le=w(C.totalVenta)||D,A=w(C.efectivo),q=w(C.dolares),ee=w(C.cambio),Q=w(C.ingresoCaja),W=w(C.tarjeta),y=w(C.transferencia),Y=w(C.credito);let L=le||D;(g==="salida"||g.includes("devolucion")||g.includes("cancelacion")||g.includes("anulacion"))&&(L=-Math.abs(L));const B={...M,pagoDetalles:C,displayAmount:L};if(g.startsWith("venta")||g.includes("abono")||g.includes("pedido")||g.includes("apartado")?(u+=W,c+=y,I+=Y):g==="ajuste"&&(C.target==="tarjeta"&&(u+=D),C.target==="credito"&&(I+=D),C.target==="transferencia"&&(c+=D)),g.startsWith("venta")){if(A>.001||q>.001||ee>.001)n+=A-ee,r+=q,t+=A-ee,x+=q;else if(Q>.001)n+=Q,t+=Q;else{const G=W+y+Y,z=le-G;z>.001&&(n+=z,t+=z)}j+=W,v+=y,K+=Y}else if(g.includes("abono")||g.includes("liquidación")||g.includes("liquidacion")||g.includes("pedido")){if(q>.001)r+=q,n+=A,s+=q,$+=A;else if(A>.001)n+=A,$+=A;else if(Q>.001)n+=Q,$+=Q;else{const G=W+y,z=Math.max(0,D-G);n+=z,$+=z}P+=W,V+=y}else if(g==="entrada")n+=Math.abs(D);else if(g==="salida")n-=Math.abs(D);else if(g.includes("devolucion")||g.includes("cancelacion")||g.includes("anulacion"))if(C.ingresoCaja!==void 0&&C.ingresoCaja!==null)n+=w(C.ingresoCaja);else if(A>.001)n-=A;else{const G=W+y+Y,z=Math.abs(D)-G;z>.001&&(n-=z)}else if(g==="ajuste")C.target==="efectivo"?(n+=D,C.hidden&&(m+=D)):C.target==="dolares"&&(r+=D);else{const G=W+y+Y,z=D-G;Math.abs(z)>.001&&(n+=z)}g.startsWith("venta")||g.includes("abono")||g.includes("liquid")||g.includes("pedido")?F+=Math.abs(L):g.includes("devolucion")||g.includes("cancelacion")||g.includes("anulacion")?F-=Math.abs(L):(g==="ajuste"&&C.target==="ventas_totales"||g==="ajuste"&&C.target==="efectivo"&&D<0)&&(F+=D),g.startsWith("venta")?p.ventasContado.push(B):g.includes("devolucion")?(p.devoluciones.push(B),T+=Math.abs(L)):g.includes("cancelacion")||g.includes("anulacion")?(p.cancelaciones.push(B),T+=Math.abs(L)):g==="entrada"?p.entradas.push(B):g==="salida"?p.salidas.push(B):g.includes("abono")?p.abonos.push(B):g==="ajuste"&&p.ajustes.push(B)}n=w(n),r=w(r),u=w(u),c=w(c),I=w(I),F=w(F),m=w(m),T=w(T);const Z=b+n,k=Z+r*S;return{cajaInicial:b,netCordobas:n,netDolares:r,efectivoEsperado:w(k),efectivoEsperadoCordobas:w(Z),efectivoEsperadoDolares:r,totalVentasDia:w(F),totalTarjeta:u,totalTransferencia:c,totalCredito:I,totalNoEfectivo:w(u+c+I),sumDevolucionesCancelaciones:T,totalHidden:m,tasaRef:S,lists:p,vEfectivoC:w(t),vEfectivoD:w(x),vTarjeta:w(j),vTransf:w(v),vCredito:w(K),aEfectivoC:w($),aEfectivoD:w(s),aTarjeta:w(P),aTransf:w(V)}},ve=o=>Number(o||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});async function Be(o,f=4){const a=localStorage.getItem("token"),b=o.filter(n=>{const r=ge(n);return!r||r!=="loading"&&r!=="none"});let S=0;async function p(){if(S>=b.length)return;const n=b[S++];if(ge(n))return p();he(n,"loading");try{const r=await Pe(n,a),u=(r==null?void 0:r.imagen)||null;he(n,u||"none")}catch{he(n,"none")}return p()}await Promise.all(Array.from({length:f},p))}function yt(o){const[f,a]=l.useState(()=>{const p=ge(o);return p&&p!=="loading"&&p!=="none"?p:null}),b=l.useRef(null),S=l.useCallback(async()=>{if(!o)return;const p=ge(o);if(!(p==="loading"||p==="none")){if(p&&p!=="loading"){a(p);return}he(o,"loading");try{const n=localStorage.getItem("token"),r=await Pe(o,n),u=(r==null?void 0:r.imagen)||null;he(o,u||"none"),a(u||null)}catch{he(o,"none"),a(null)}}},[o]);return l.useEffect(()=>{const p=ge(o);if(p&&p!=="loading"){a(p!=="none"?p:null);return}const n=setInterval(()=>{const u=ge(o);u&&u!=="loading"&&(a(u!=="none"?u:null),clearInterval(n))},200),r=new IntersectionObserver(u=>{u[0].isIntersecting&&S()},{rootMargin:"200px"});return b.current&&r.observe(b.current),()=>{r.disconnect(),clearInterval(n)}},[o,S]),{imgSrc:f,cardRef:b}}function vt({productId:o,productName:f,onView:a}){const{imgSrc:b,cardRef:S}=yt(o);return e.jsxs("div",{ref:S,className:"image-placeholder",style:{position:"relative",height:160,background:"#f8fafc",display:"flex",alignItems:"center",justifyContent:"center",borderBottom:"1px solid #f1f5f9",overflow:"hidden"},children:[b&&e.jsx("div",{className:"eye-icon",onClick:p=>{p.stopPropagation(),a(b)},style:{position:"absolute",top:10,left:10,zIndex:20,background:"white",borderRadius:"50%",width:32,height:32,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 6px rgba(0,0,0,0.1)",cursor:"pointer",transition:"transform 0.2s"},title:"Ver imagen",children:e.jsx(He,{size:14,color:"#64748b"})}),b?e.jsx("img",{src:b,alt:f,loading:"lazy",style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain"}}):e.jsx(Ue,{className:"no-image-icon",size:40,color:"#e2e8f0"})]})}const Oe=se.button`
...
`,Bt=({currentUser:o,isCajaOpen:f,session:a,onOpenCaja:b,onCloseCaja:S,onClose:p,isAdmin:n,showConfirmation:r,showAlert:u,initialTasaDolar:c,clients:I=[]})=>{var ye,d;const[T,F]=l.useState(""),[m,E]=l.useState(c||36.6),[t,x]=l.useState(""),[j,v]=l.useState(!1),K=Ye(),$=(o==null?void 0:o.id_usuario)||(o==null?void 0:o.id);let s=(ye=a==null?void 0:a.openedBy)==null?void 0:ye.name;!s&&(a!=null&&a.openedBy)&&typeof a.openedBy=="string"&&(s=a.openedBy),s||(s=(a==null?void 0:a.userId)===$?(o==null?void 0:o.nombre_usuario)||(o==null?void 0:o.username):"Usuario"),s||(s="Caja General");const P=n||(a==null?void 0:a.userId)===$||((d=a==null?void 0:a.openedBy)==null?void 0:d.id)===$,V=l.useMemo(()=>Array.isArray(a==null?void 0:a.transactions)?a.transactions:[],[a]),Z=l.useMemo(()=>{const i=jt(V,(a==null?void 0:a.initialAmount)||0,(a==null?void 0:a.tasaDolar)||c);return a!=null&&a.stats&&a.stats.vEfectivoC!==void 0?{...a.stats,lists:a.stats.lists||i.lists}:i},[V,a,c]),{cajaInicial:k,netCordobas:M,netDolares:g,efectivoEsperado:C,efectivoEsperadoCordobas:D,efectivoEsperadoDolares:le,totalTarjeta:A,totalTransferencia:q,totalCredito:ee,totalNoEfectivo:Q,sumDevolucionesCancelaciones:W,totalHidden:y,tasaRef:Y,vEfectivoC:L,vEfectivoD:pe,vTarjeta:B,vTransf:G,vCredito:z,aEfectivoC:me,aEfectivoD:re,aTarjeta:ie,aTransf:te,lists:{ventasContado:xe,devoluciones:oe,cancelaciones:ze,entradas:X,salidas:H,abonos:ne}}=Z,de=(L||0)+(pe||0)*Y+(B||0)+(G||0)+(z||0)+(me||0)+(re||0)*Y+(ie||0)+(te||0)-(W||0),_=Number(t||0)-C;a!=null&&a.openedAt&&new Date(a.openedAt);const Ce=()=>{const i=parseFloat(T||0);if(isNaN(i)||i<0)return u({title:"Inválido",message:"Monto inicial >= 0"});b(i,Number(m||36.6))},we=()=>{if(isNaN(parseFloat(t)))return u({title:"Requerido",message:"Ingrese el monto contado físico."});v(!0)},Se=ke.useCallback(()=>{const i=document.getElementById("print-wrapper-caja");if(!i)return;const N=i.outerHTML,U=`
        @charset "UTF-8";
        @import url('https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;600;800;900&display=swap');
...
`,$t=({cart:o=[],total:f=0,subtotal:a=0,discount:b=0,proformaFor:S="",onClose:p,currentUser:n,client:r})=>{const{user:u}=typeof De=="function"?De():{user:null},{settings:c}=mt(),I=s=>(s==null?void 0:s.usuarioNombre)||(s==null?void 0:s.nombre_usuario)||(s==null?void 0:s.name)||(s==null?void 0:s.nombre)||(s==null?void 0:s.username)||null;let T=null;try{T=JSON.parse(localStorage.getItem("authUser")||"null")}catch{}const F=I(n)||I(u)||I(T)||"Cajero POS",m=(r==null?void 0:r.nombre)||"Consumidor Final",E=(r==null?void 0:r.cedula)||"",t=new Date().toLocaleString("es-NI"),x=s=>new Intl.NumberFormat("es-NI",{minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(s||0)),j=ke.useMemo(()=>c!=null&&c.empresa_logo_url?c.empresa_logo_url.startsWith("http")?c.empresa_logo_url:`${"https://sistema.multirepuestosrg.com/api".replace(/\/api$/,"")}${c.empresa_logo_url.startsWith("/")?"":"/"}${c.empresa_logo_url}`:null,[c==null?void 0:c.empresa_logo_url]),v={name:(c==null?void 0:c.empresa_nombre)||"Multirepuestos RG",ruc:(c==null?void 0:c.empresa_ruc)||"1211812770001E",phone:(c==null?void 0:c.empresa_telefono)||"84031936 / 84058142",address:(c==null?void 0:c.empresa_direccion)||"Del portón de la normal 75 varas al este. Juigalpa, Chontales.",slogan:(c==null?void 0:c.empresa_eslogan)||"Tu mejor opción en repuestos",logo:j||new URL("/icons/logo.png",window.location.origin).toString()},K=l.useCallback((s="80")=>{const P=document.getElementById("print-wrapper-proforma");if(!P)return;const V=P.outerHTML,k=`
      @charset "UTF-8";
      @import url('https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;500;600;700;800&display=swap');
      @page { size: ${s==="A4"?"A4 portrait":"80mm auto"}; margin: ${s==="A4"?"12mm":"0"}; }
      html, body {
        background: #fff; margin: 0 !important; padding: 0 !important;
        -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important;
        color: #000 !important;
      ...
      #print-wrapper-proforma {
        ...
        ${s==="A4"?"width: 100% !important; padding: 0 !important; font-size: 10pt !important;":"width: 80mm !important; padding: 6px 4px !important; font-size: 9pt !important;"}
      }
      ...
      #print-wrapper-proforma .brand-logo-container img {
        max-width: ${s==="A4"?"130px":"110px"} !important;
        max-height: ${s==="A4"?"90px":"110px"} !important;
