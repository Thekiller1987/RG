import{u as F,r as u,j as e,W as N,I as E,w as T,Z as _,L as B,A as C,a1 as q,be as G,a5 as L,b5 as A,s as a,m as z,aj as h,n as O,D}from"./vendor-B-pOHZxB.js";import{u as R,W as k}from"./index-C9q57MBf.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-DGlygaeZ.js";const V=a.div`
  max-width: 1400px;
  margin: 0 auto;
  padding: 2rem;
...
`,te=({product:o,onSave:l,onClose:c})=>{const[t,g]=u.useState({nombre:o.nombre,descripcion:o.descripcion||"",venta:o.venta,mayoreo:o.mayoreo||"",distribuidor:o.distribuidor||"",mayorista:o.mayorista||"",taller:o.taller||""}),n=i=>g({...t,[i.target.name]:i.target.value});return e.jsx(oe,{initial:{opacity:0},border:!0,animate:{opacity:1},exit:{opacity:0},onClick:c,children:e.jsxs(ae,{onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"1.5rem"},children:[e.jsxs("h2",{style:{margin:0,color:"#1e293b"},children:["Configurar Precios: ",o.codigo]}),e.jsx("button",{onClick:c,style:{border:"none",background:"none",cursor:"pointer",color:"#64748b"},children:e.jsx(O,{size:20})})]}),e.jsxs(d,{children:[e.jsx(x,{children:"Nombre del Producto"}),e.jsx(p,{name:"nombre",value:t.nombre,onChange:n})]}),e.jsxs(d,{children:[e.jsx(x,{children:"Descripción"}),e.jsx(p,{name:"descripcion",value:t.descripcion,onChange:n})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"1rem"},children:[e.jsxs(d,{children:[e.jsx(x,{children:"Precio Tienda (Público)"}),e.jsx(p,{type:"number",name:"venta",value:t.venta,onChange:n})]}),e.jsxs(d,{children:[e.jsx(x,{children:"Mayoreo"}),e.jsx(p,{type:"number",name:"mayoreo",value:t.mayoreo,onChange:n})]}),e.jsxs(d,{children:[e.jsx(x,{children:"Distribuidor"}),e.jsx(p,{type:"number",name:"distribuidor",value:t.distribuidor,onChange:n})]}),e.jsxs(d,{children:[e.jsx(x,{children:"Mayorista"}),e.jsx(p,{type:"number",name:"mayorista",value:t.mayorista,onChange:n})]})]}),e.jsxs(ie,{children:[e.jsx(P,{onClick:c,children:"Cancelar"}),e.jsxs(S,{$active:!0,onClick:()=>l(t),style:{borderRadius:"10px"},children:[e.jsx(D,{})," Guardar Cambios"]})]})]})})},de=()=>{const o=F(),{products:l,token:c,refreshProducts:t}=R(),[g,n]=u.useState(""),[i,$]=u.useState(!1),[f,j]=u.useState(null),v=u.useDeferredValue(g),w=u.useMemo(()=>{if(!l)return[];let r=i?l:l.filter(m=>!!m.catalogo_mayorista);const s=v.toLowerCase().trim();return s?r.filter(m=>(m.nombre||"").toLowerCase().includes(s)||(m.codigo||"").toLowerCase().includes(s)||(m.descripcion||"").toLowerCase().includes(s)):r},[l,v,i]),I=async r=>{try{const s=r.catalogo_mayorista?0:1;await k(r.id_producto,{...r,catalogo_mayorista:s},c),h.success(s?"Producto activado":"Producto ocultado"),t()}catch{h.error("Error al actualizar visibilidad")}},M=async r=>{try{await k(f.id_producto,{...f,...r,mayoreo:r.mayoreo||null,distribuidor:r.distribuidor||null,taller:r.taller||null,mayorista:r.mayorista||null},c),h.success("Producto actualizado"),j(null),t()}catch{h.error("Error al guardar cambios")}},b=r=>new Intl.NumberFormat("es-NI",{style:"currency",currency:"NIO",currencyDisplay:"code"}).format(Number(r||0)).replace("NIO","C$");return e.jsxs(V,{children:[e.jsxs(W,{children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"20px"},children:[e.jsxs(P,{onClick:()=>o("/wholesale-menu"),children:[e.jsx(N,{})," Volver"]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[e.jsx(E,{size:28,color:"#8b5cf6"}),e.jsx("h1",{style:{margin:0,fontSize:"1.8rem",color:"#1e293b"},children:"Catálogo Mayorista"})]})]}),e.jsxs(S,{$active:i,onClick:()=>$(!i),children:[e.jsx(T,{})," ",i?"Finalizar Gestión":"Gestionar Catálogo"]})]}),e.jsx(H,{children:e.jsxs(Y,{children:[e.jsx(_,{}),e.jsx("input",{type:"text",placeholder:"Buscar por nombre, código o descripción...",value:g,onChange:r=>n(r.target.value)})]})}),w.length===0?e.jsxs("div",{style:{textAlign:"center",padding:"5rem",background:"white",borderRadius:"16px",color:"#64748b"},children:[e.jsx(B,{size:64,style:{marginBottom:"1.5rem",opacity:.3}}),e.jsx("h3",{children:"No se encontraron productos"}),e.jsx("p",{children:i?"No hay productos en el inventario.":"Configura los productos para que aparezcan aquí."})]}):e.jsx(U,{children:e.jsx(C,{children:w.map(r=>e.jsxs(X,{$active:!!r.catalogo_mayorista,initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,scale:.95},children:[i&&e.jsx(re,{$active:!!r.catalogo_mayorista,onClick:()=>I(r),title:r.catalogo_mayorista?"Ocultar del catálogo":"Mostrar en catálogo",children:r.catalogo_mayorista?e.jsx(q,{}):e.jsx(G,{})}),e.jsxs(Q,{qty:r.existencia,children:["Stock: ",r.existencia]}),e.jsx(Z,{children:e.jsxs(J,{children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start"},children:[e.jsx("small",{children:r.codigo||"S/C"}),e.jsxs(ee,{onClick:()=>j(r),children:[e.jsx(L,{})," Editar"]})]}),e.jsx("h3",{children:r.nombre}),e.jsx("p",{style:{margin:"5px 0 0 0",fontSize:"0.9rem",color:"#64748b"},children:r.descripcion})]})}),e.jsxs(K,{children:[e.jsxs(y,{children:[e.jsx("label",{children:"Precio Tienda"}),e.jsx("span",{children:b(r.venta||0)})]}),e.jsxs(y,{className:"featured",children:[e.jsx("label",{children:"Mayoreo"}),e.jsx("span",{children:b(r.mayoreo||0)})]}),e.jsxs(y,{className:"featured",children:[e.jsx("label",{children:"Distribuidor"}),e.jsx("span",{children:b(r.distribuidor||0)})]}),e.jsxs(y,{className:"featured",children:[e.jsx("label",{children:"Especial"}),e.jsx("span",{children:b(r.mayorista||0)})]})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",fontSize:"0.85rem",color:"#94a3b8",marginTop:"auto"},children:[e.jsx(A,{}),e.jsx("span",{children:"Precios sujetos a cambios según promociones activas."})]})]},r.id_producto||r.id))})}),e.jsx(C,{children:f&&e.jsx(te,{product:f,onClose:()=>j(null),onSave:M})})]})};export{de as default};
