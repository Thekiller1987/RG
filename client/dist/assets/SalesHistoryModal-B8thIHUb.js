import{R as X,r as s,j as e,k as xt,I as ft,a9 as ht,D as gt,s as p,v as ut,x as ze,aQ as bt,ae as _e,C as jt,q as yt,ad as de,bc as Ct,b5 as Ue,g as Ge,bd as rt,be as wt,J as vt,b0 as at,aj as Nt,Y as Ze,Z as kt,S as $t,aO as St,bf as At,bg as Tt,b1 as it,ah as It,ak as Dt,bh as Je,af as Te}from"./vendor-CKKIjxqY.js";import{M as ke,B as A,f as W,a as Pe,I as $e,S as Ce}from"./POS.styles-CJ3yykZz.js";import{u as Le,_ as Et,o as Ft,a as zt,r as Lt}from"./index-CtxqgSa7.js";import{A as Mt}from"./AlertModal-DDPiO14r.js";import{r as Rt}from"./searchEngine-BMYcElFi.js";const _t=p.div`
...
`,Vt=p.h2`margin: 0; font-size: 1.5rem; color: #333;`,Bt=p.button`
  ...
  &:hover { color: #333; }
`,Wt=p.form`display: flex; flex-direction: column; gap: 1.25rem;`,Ie=p.div`display: flex; flex-direction: column; gap: 0.5rem;`,De=p.label`font-weight: 600; color: #495057; font-size: 0.9rem;`,Me=p.input`
...
`,qt=p(Me).attrs({as:"select"})``,Ye=p.button`
...
`,ge=t=>`C$${Number(t||0).toFixed(2)}`,et=t=>t?new Date(t).toLocaleDateString("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}):"—",Zt=({client:t,onClose:o,onAbonoSuccess:x,showAlert:f})=>{const{addCajaTransaction:C,user:u}=Le(),[d,k]=s.useState(""),[y,L]=s.useState("Efectivo"),[b,l]=s.useState(""),[T,E]=s.useState(!1),[D,i]=s.useState(""),[S,j]=s.useState([]),[M,m]=s.useState(!0),[g,ee]=s.useState(null),V=s.useMemo(()=>Number(t==null?void 0:t.saldo_pendiente)||0,[t]);s.useEffect(()=>{const c=async()=>{m(!0);try{const w=localStorage.getItem("token"),_=await Ft(t.id_cliente,w);j(Array.isArray(_)?_:[])}catch(w){console.error("Error cargando tickets:",w),j([])}finally{m(!1)}};t!=null&&t.id_cliente&&c()},[t]);const I=s.useMemo(()=>S.filter(c=>c.saldoRestante>0),[S]),re=s.useMemo(()=>S.filter(c=>c.saldoRestante<=0),[S]),R=g?Math.min(V,g.saldoRestante):V;s.useEffect(()=>{if(!d){i("");return}const c=parseFloat(d);isNaN(c)||c<=0?i("Ingrese un monto válido mayor a cero."):c>R?i(`El máximo es ${ge(R)}.`):i("")},[d,R]);const ae=c=>{c.saldoRestante<=0||(ee(w=>(w==null?void 0:w.idVenta)===c.idVenta?null:c),k(""))},te=()=>{k(g?g.saldoRestante.toFixed(2):V.toFixed(2))},F=s.useCallback((c,w,_,z)=>{const N=Math.max(0,z-c),ce=new Date().toLocaleString("es-NI",{timeZone:"America/Managua"}),ne=g?`Venta #${g.idVenta}`:"Cuenta General",U=`
    ...
    `,P=window.open("","_blank","width=400,height=600");P&&(P.document.write(`<!DOCTYPE html><html><head><title>Comprobante Abono</title><link href="https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;700;900&display=swap" rel="stylesheet"><style>@page{size:80mm auto;margin:0;}body{margin:0;padding:0;-webkit-print-color-adjust:exact;print-color-adjust:exact;}*{font-weight:800!important;color:#000!important;}</style></head><body>${U}</body></html>`),P.document.close(),P.focus(),P.onload=function(){setTimeout(()=>{P.print(),setTimeout(()=>P.close(),500)},400)})},[t,g]),r=s.useCallback(async c=>{c.preventDefault();const w=parseFloat(d),_=localStorage.getItem("token");if(D||!w||w<=0){f==null||f({title:"Monto Inválido",message:D||"Revise el monto ingresado."});return}if(y!=="Efectivo"&&!b.trim()){f==null||f({title:"Referencia Requerida",message:"Ingrese el número de referencia, transferencia o voucher."});return}E(!0);try{await Et(t.id_cliente,{monto:w,id_venta:(g==null?void 0:g.idVenta)||null,pagoDetalles:{metodo:y,usuario:(u==null?void 0:u.nombre_usuario)||"Desconocido",referencia:b||"",ticketRef:g?`Venta #${g.idVenta}`:"FIFO"}},_);const z=y==="Efectivo",N={id:`abono-${Date.now()}`,type:"abono",amount:w,note:`Abono Cliente: ${t.nombre} (${y})${g?` - Venta #${g.idVenta}`:""} ${b?"- Ref: "+b:""}`,at:new Date().toISOString(),pagoDetalles:{clienteId:t.id_cliente,clienteNombre:t.nombre,metodo:y,referencia:b,ingresoCaja:z?w:0,efectivo:z?w:0,tarjeta:y==="Tarjeta"?w:0,transferencia:y==="Transferencia"?w:0,credito:0}};await C(N),F(w,y,b,V),x==null||x(N),o==null||o()}catch(z){console.error("Error al registrar abono:",z),f==null||f({title:"Error",message:`No se pudo registrar el abono. ${z.message}`})}finally{E(!1)}},[d,y,b,D,t,u,g,C,x,o,f,F,V]),J=T||V<=0||!!D||!d;return e.jsx(_t,{children:e.jsxs(Pt,{children:[e.jsxs(Ot,{children:[e.jsx(Vt,{children:"Registrar Abono"}),e.jsx(Bt,{onClick:o,disabled:T,children:e.jsx(xt,{})})]}),e.jsxs("p",{children:["Cliente: ",e.jsx("strong",{children:(t==null?void 0:t.nombre)||"Desconocido"})]}),e.jsxs(Ht,{children:["Saldo Pendiente Total: ",e.jsx("strong",{children:ge(V)})]}),M?e.jsxs("div",{style:{textAlign:"center",padding:"1rem",color:"#6c757d"},children:[e.jsx(Qe,{})," Cargando facturas..."]}):I.length>0?e.jsxs(e.Fragment,{children:[e.jsxs(Gt,{children:[e.jsx(ft,{})," Selecciona una factura (opcional — si no, paga la más antigua):"]}),e.jsx(Ke,{children:I.map(c=>e.jsxs(Xe,{$selected:(g==null?void 0:g.idVenta)===c.idVenta,onClick:()=>ae(c),children:[e.jsxs("div",{className:"ticket-info",children:[e.jsxs("span",{className:"ticket-id",children:["Venta #",c.idVenta]}),e.jsx("span",{className:"ticket-date",children:et(c.fecha)})]}),e.jsxs("div",{className:"ticket-amounts",children:[c.montoOriginal!==c.saldoRestante&&e.jsx("div",{className:"original",children:ge(c.montoOriginal)}),e.jsx("div",{className:"remaining",children:ge(c.saldoRestante)})]})]},c.idVenta))}),re.length>0&&e.jsxs("details",{style:{marginTop:"0.5rem"},children:[e.jsxs("summary",{style:{cursor:"pointer",fontSize:"0.85rem",color:"#6c757d"},children:[e.jsx(ht,{style:{color:"#28a745"}})," ",re.length," factura(s) pagada(s)"]}),e.jsx(Ke,{style:{marginTop:"0.5rem"},children:re.map(c=>e.jsxs(Xe,{$paid:!0,children:[e.jsxs("div",{className:"ticket-info",children:[e.jsxs("span",{className:"ticket-id",children:["Venta #",c.idVenta]}),e.jsx("span",{className:"ticket-date",children:et(c.fecha)})]}),e.jsx("div",{className:"ticket-amounts",children:e.jsx("div",{className:"remaining",style:{color:"#28a745"},children:"Pagada ✔"})})]},c.idVenta))})]})]}):null,e.jsxs(Wt,{onSubmit:r,children:[e.jsxs(Ie,{children:[e.jsxs(De,{htmlFor:"montoAbono",children:["Monto a Abonar (C$)",g&&e.jsxs("span",{style:{fontWeight:"normal",color:"#007bff",marginLeft:"0.5rem"},children:["— Venta #",g.idVenta," (máx: ",ge(R),")"]})]}),e.jsxs("div",{style:{display:"flex",gap:"0.5rem"},children:[e.jsx(Me,{id:"montoAbono",type:"number",value:d,onChange:c=>k(c.target.value),placeholder:"0.00",required:!0,autoFocus:!0,step:"0.01",min:"0.01",max:R?R.toFixed(2):void 0,disabled:T||V<=0,style:{flex:1}}),e.jsx(Ye,{type:"button",onClick:te,style:{background:"#007bff",padding:"0.5rem 0.75rem",fontSize:"0.85rem"},disabled:T||V<=0,children:"Total"})]})]}),e.jsxs(Ie,{children:[e.jsx(De,{htmlFor:"metodoPago",children:"Método de Pago"}),e.jsxs(qt,{id:"metodoPago",value:y,onChange:c=>L(c.target.value),disabled:T,children:[e.jsx("option",{value:"Efectivo",children:"Efectivo"}),e.jsx("option",{value:"Tarjeta",children:"Tarjeta"}),e.jsx("option",{value:"Transferencia",children:"Transferencia"})]})]}),y!=="Efectivo"&&e.jsxs(Ie,{children:[e.jsx(De,{htmlFor:"referencia",children:"Referencia / Voucher / N° Transferencia"}),e.jsx(Me,{id:"referencia",type:"text",value:b,onChange:c=>l(c.target.value),placeholder:"Ej: BAC-123456",required:!0})]}),D&&e.jsx(Ut,{children:D}),e.jsx(Ye,{type:"submit",disabled:J,children:T?e.jsxs(e.Fragment,{children:[e.jsx(Qe,{})," Procesando..."]}):e.jsxs(e.Fragment,{children:[e.jsx(gt,{})," Registrar Abono"]})})]})]})})},Jt=X.memo(Zt),Yt=yt`
  @media print {
...
`,G=t=>new Intl.NumberFormat("es-NI",{minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(t||0)),$=(...t)=>t.find(o=>o!=null),le=t=>$(t==null?void 0:t.usuarioNombre,t==null?void 0:t.nombre_usuario,t==null?void 0:t.nombre,t==null?void 0:t.name,t==null?void 0:t.displayName,t==null?void 0:t.fullName,t==null?void 0:t.username,null);function nn(t=[]){return t.map((o,x)=>{const f=Number($(o.quantity,o.cantidad,o.qty,0)),C=$(o.nombre,o.descripcion,o.description,o.producto,`Item ${x+1}`),u=Number($(o.precio_unitario,o.precio_venta,o.precio,o.unitPrice,0));return{id:$(o.id_producto,o.id,`it-${x}`),nombre:C,quantity:f,unit:u,total:f*u}})}function on(t={}){const o=Number(t.efectivo||0),x=Number(t.tarjeta||0),f=Number(t.transferencia||0),C=Number(t.dolares||0);if(Number(t.credito||0)>0)return"Crédito";const d=[];return o>0&&d.push("Efectivo"),x>0&&d.push("Tarjeta"),f>0&&d.push("Transferencia"),C>0&&d.push("Dólares"),d.length===0?"Contado":d.length===1?d[0]:"Mixto"}function rn(t={},o=0){const x=Number(t.efectivo||0),f=Number(t.tarjeta||0),C=Number(t.transferencia||0),u=Number(t.otro||0),d=Number(t.dolares||0),k=Number(t.tasaDolarAlMomento||t.tasaObtenida||1),y=d*(k>1?k:1),L=x+f+C+u+y;return L>0?L:Number(t.montoRecibido||o||0)}function an(t){const o=$(t==null?void 0:t.fecha,t==null?void 0:t.createdAt,t==null?void 0:t.created_at,t==null?void 0:t.date,t);try{const x=new Date(o);return isNaN(x)?"Fecha inválida":x.toLocaleString("es-NI",{hour12:!0})}catch{return"Fecha inválida"}}function sn(t){const o=$(t.proformaId,t.proformaNumero,t.numeroProforma,t.id);if(o)return o;const x=new Date,f=x.toISOString().slice(2,10).replace(/-/g,""),C=x.toTimeString().slice(0,8).replace(/:/g,"");return`PF-${f}-${C}`}const En=({transaction:t,onClose:o,clients:x=[],users:f=[],isOpen:C=!0,printMode:u="80",currentUser:d=null,onPersistPrint:k=null,autoTriggerPrint:y=!1,showAlert:L=null})=>{var xe;const{user:b}=typeof Le=="function"?Le():{user:null},{settings:l}=zt();if(!C||t==null)return null;const[T]=X.useState(typeof t=="object"?t:null),[E]=X.useState(!1),[D]=X.useState(null);if(E||D||!T)return e.jsx(ke,{className:"no-print",children:e.jsxs(tt,{className:"no-print",style:{maxWidth:420,padding:"1rem"},children:[e.jsx("h3",{style:{color:"#dc3545"},children:"No se pudo imprimir"}),e.jsx("div",{style:{display:"flex",justifyContent:"center",marginTop:12},children:e.jsxs(A,{onClick:o,$cancel:!0,children:[e.jsx(ze,{})," Cerrar"]})})]})});const i=T,S=i.estado==="ABONO_CREDITO",j=!!(i.isProforma||i.proformaFor||i.proformaNombre),M=!!i.isOutflow,m=i.estado==="DEVOLUCION",g=j?sn(i):$(i.id,i.saleId,i.numero,"-"),ee=an($(i.fecha,i.createdAt,i.date)),V=$(i.clientId,i.idCliente,i.clienteId),I=x.find(h=>String(h.id_cliente??h.id)===String(V)),re=j&&i.proformaNombre?i.proformaNombre:$(I==null?void 0:I.nombre,i.clienteNombre,"Consumidor Final"),R=(I==null?void 0:I.cedula)||i.clienteCedula,ae=$(i.userId,i.idUsuario,(xe=i.openedBy)==null?void 0:xe.id)??(d==null?void 0:d.id_usuario)??(d==null?void 0:d.id)??(d==null?void 0:d.uid)??(b==null?void 0:b.id_usuario)??(b==null?void 0:b.id)??(b==null?void 0:b.uid),te=(()=>{try{return JSON.parse(localStorage.getItem("authUser")||"null")}catch{return null}})(),F=f.find(h=>String(h.id_usuario||h.id||h.uid)===String(ae)),r=$(i.usuarioNombre,le(F),le(d),le(b),le(te),"Cajero POS"),J=j?$(i.usuarioNombre,le(d),le(b),le(te),r):r,c=nn($(i.items,i.detalle,[])),w=c.reduce((h,B)=>h+Number(B.unit)*Number(B.quantity),0),_=Number($(i.subtotal,w)),z=Number($(i.descuento,0)),N=Number($(i.totalVenta,i.total_venta,_-z,0)),ce=i.pagoDetalles||{},ne=j||M?"N/A":$(i.metodoPago,on(ce)),U=j||M?0:rn(ce,N),P=j||M?0:Math.max(0,U-N),ie=Math.abs(Number($(i.totalVenta,i.montoAbono,0))),Y=Number((I==null?void 0:I.saldo_pendiente)||0),be=Y+ie,je=c.length<=2,me=s.useMemo(()=>l!=null&&l.empresa_logo_url?l.empresa_logo_url.startsWith("http")?l.empresa_logo_url:`${"https://sistema.multirepuestosrg.com/api".replace(/\/api$/,"")}${l.empresa_logo_url.startsWith("/")?"":"/"}${l.empresa_logo_url}`:null,[l==null?void 0:l.empresa_logo_url]),O={name:(l==null?void 0:l.empresa_nombre)||"Multirepuestos RG",ruc:(l==null?void 0:l.empresa_ruc)||"1211812770001E",phone:(l==null?void 0:l.empresa_telefono)||"84031936 / 84058142",address:(l==null?void 0:l.empresa_direccion)||"Del portón de la normal 75 varas al este. Juigalpa, Chontales.",slogan:(l==null?void 0:l.empresa_eslogan)||"Repuestos de confianza al mejor precio",logo:me||new URL("/icons/logo.png",window.location.origin).toString()};X.useCallback(async h=>{},[]);const oe=X.useCallback((h="80",B=!1)=>{const fe=document.getElementById("print-wrapper-ticket");if(!fe)return;const Se=fe.outerHTML,pe=`
      ...
      `}
    `,Q=window.open("","_blank","width=900,height=700");Q&&(Q.document.write(`<html><head><title>Impresión ${h.toUpperCase()} - ${O.name}</title><style>${pe}</style></head><body>${Se}</body></html>`),Q.document.close(),Q.focus(),setTimeout(()=>{try{Q.print()}catch(he){console.error("Print error:",he)}setTimeout(()=>{try{Q.close()}catch{}},1e3)},400),B&&setTimeout(()=>{o&&o()},800))},[O,o]),se=s.useRef(!1);return s.useEffect(()=>{if(y&&!se.current){se.current=!0;const h=setTimeout(()=>oe("80",!0),500);return()=>clearTimeout(h)}},[y,oe]),e.jsxs(ke,{className:"no-print",children:[e.jsx(Yt,{}),e.jsxs(tt,{className:"no-print",children:[e.jsxs(en,{children:[e.jsxs("h2",{style:{display:"flex",alignItems:"center",gap:8,margin:0},children:[e.jsx(bt,{color:"#2563eb"})," Vista de Impresión"]}),e.jsxs(tn,{children:[e.jsxs(A,{onClick:()=>oe("80"),style:{background:"#2563eb",color:"#fff",fontWeight:700},children:[e.jsx(_e,{})," 80mm"]}),e.jsxs(A,{onClick:()=>oe("A4"),style:{background:"#0f766e",color:"#fff",fontWeight:700},children:[e.jsx(jt,{})," A4"]}),e.jsx(A,{$cancel:!0,onClick:o,style:{background:"#fee2e2",color:"#ef4444"},children:e.jsx(ze,{})})]})]}),e.jsx(Kt,{children:e.jsxs(Qt,{id:"print-wrapper-ticket",className:`print-area ${u==="A4"?"print-a4":"print-80"} ${je?"compact":""}`,children:[e.jsxs("div",{className:"brand",children:[e.jsx("div",{className:"brand-logo-container",children:e.jsx(Xt,{className:u==="A4"?"logo-a4":"logo-80mm",src:O.logo,alt:"Logo",onError:h=>{h.currentTarget.style.display="none"}})}),e.jsxs("div",{className:"brand-info",children:[e.jsx("h1",{children:O.name}),e.jsx("small",{children:e.jsx("strong",{children:O.slogan})}),e.jsxs("small",{children:[e.jsx("strong",{children:"RUC:"})," ",O.ruc]}),e.jsxs("small",{children:[e.jsx("strong",{children:"Tel:"})," ",O.phone]}),e.jsx("small",{children:O.address}),e.jsx("div",{style:{marginTop:8},children:j?e.jsx(ue,{$type:"proforma",className:"ticket-tag",children:"PROFORMA"}):S?e.jsx(ue,{$type:"abono",className:"ticket-tag",children:"RECIBO"}):M?e.jsx(ue,{$type:"outflow",className:"ticket-tag",children:"SALIDA"}):i.isProReceipt||i.isWholesale?e.jsx(ue,{$type:"pro",className:"ticket-tag",children:"RECIBO PRO"}):e.jsx(ue,{$type:"venta",className:"ticket-tag",children:m?"DEVOLUCIÓN":"FACTURA"})})]})]}),e.jsxs("div",{className:"meta",children:[e.jsxs("div",{className:"meta-col",children:[e.jsx("span",{className:"meta-title",children:"Detalles del Documento"}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Fecha:"}),e.jsx("span",{className:"meta-value",children:ee})]}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"No. Documento:"}),e.jsx("span",{className:"meta-value",children:g})]}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Atendido por:"}),e.jsx("span",{className:"meta-value",children:J})]})]}),e.jsxs("div",{className:"meta-col",children:[e.jsx("span",{className:"meta-title",children:"Datos del Cliente"}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Cliente:"}),e.jsx("span",{className:"meta-value",children:re})]}),R&&e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Cédula/RUC:"}),e.jsx("span",{className:"meta-value",children:R})]}),!j&&!M&&e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Pago:"}),e.jsx("span",{className:"meta-value",children:ne})]})]})]}),e.jsxs("table",{className:"items",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{className:"col-qty",children:"Cant."}),e.jsx("th",{children:"Descripción"}),e.jsx("th",{className:"text-right col-unit",children:"P. Unit"}),e.jsx("th",{className:"text-right col-total",children:"Total"})]})}),e.jsx("tbody",{children:c.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:"4",style:{textAlign:"center"},children:"Sin ítems"})}):c.map(h=>e.jsxs("tr",{children:[e.jsx("td",{className:"col-qty",style:{fontWeight:800},children:h.quantity}),e.jsx("td",{style:{fontWeight:600},children:h.nombre}),e.jsxs("td",{className:"text-right col-unit",children:["C$",G(h.unit)]}),e.jsxs("td",{className:"text-right col-total",style:{fontWeight:700},children:["C$",G(h.total)]})]},h.id))})]}),e.jsx("div",{className:"totals",children:e.jsx("div",{className:"totals-box",children:S?e.jsxs(e.Fragment,{children:[e.jsxs(W,{style:{marginTop:5,fontSize:"0.95em"},children:[e.jsx("span",{style:{fontWeight:700},children:"Saldo Anterior:"}),e.jsxs("span",{style:{fontWeight:700},children:["C$",G(be)]})]}),e.jsxs(W,{className:"grand-total",$bold:!0,style:{fontSize:"1.3em",borderTop:"2px solid #000",marginTop:5,paddingTop:5,color:"#28a745"},children:[e.jsx("span",{style:{fontWeight:900},children:"ABONÓ:"}),e.jsxs("span",{style:{fontWeight:900},children:["C$",G(ie)]})]}),e.jsxs(W,{$bold:!0,style:{fontSize:"1.1em",borderTop:"2px dashed #000",marginTop:5,paddingTop:5,color:Y>0?"#dc3545":"#28a745"},children:[e.jsx("span",{style:{fontWeight:900},children:"Saldo Pendiente:"}),e.jsxs("span",{style:{fontWeight:900},children:["C$",G(Y)]})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs(W,{children:[e.jsx("span",{style:{fontWeight:700},children:"Subtotal:"}),e.jsxs("span",{style:{fontWeight:700},children:["C$",G(_)]})]}),z>0&&e.jsxs(W,{style:{color:"#dc3545"},children:[e.jsx("span",{style:{fontWeight:700},children:"Descuento:"}),e.jsxs("span",{style:{fontWeight:700},children:["- C$",G(z)]})]}),e.jsxs(W,{className:"grand-total",$bold:!0,style:{fontSize:"1.3em",borderTop:"2px solid #000",marginTop:5,paddingTop:5},children:[e.jsx("span",{style:{fontWeight:900},children:"TOTAL:"}),e.jsxs("span",{style:{fontWeight:900},children:["C$",G(N)]})]}),!j&&e.jsxs(e.Fragment,{children:[e.jsxs(W,{style:{marginTop:10,fontSize:"0.9em"},children:[e.jsx("span",{style:{fontWeight:700},children:"Pagado:"}),e.jsxs("span",{style:{fontWeight:700},children:["C$",G(U)]})]}),P>0&&e.jsxs(W,{$bold:!0,style:{color:"#dc3545",fontWeight:900},children:[e.jsx("span",{children:"Cambio:"}),e.jsxs("span",{children:["C$",G(P)]})]})]})]})})}),e.jsxs("div",{className:"footer-sign no-show-80",children:[e.jsx("div",{className:"sign-box",children:"Entregado por"}),e.jsx("div",{className:"sign-box",children:"Recibido por"})]}),e.jsxs("div",{className:"thanks",children:[e.jsx("p",{children:e.jsxs("strong",{children:['"',O.slogan,'"']})}),e.jsx("p",{style:{whiteSpace:"pre-line",marginTop:"5px"},children:j?(l==null?void 0:l.ticket_proforma_footer)||"Cotización válida por 15 días.":M?(l==null?void 0:l.ticket_transfer_footer)||"Salida de Inventario.":(l==null?void 0:l.ticket_sales_footer)||"¡Gracias por su compra!"})]})]})})]})]})},Z=t=>Number(t||0).toFixed(2),ln=(t,o=0)=>(t==null?void 0:t.nombre)??(t==null?void 0:t.name)??(t==null?void 0:t.producto)??(t==null?void 0:t.descripcion)??`Item ${o+1}`,nt=p.div`
