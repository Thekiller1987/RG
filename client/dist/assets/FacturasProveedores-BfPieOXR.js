import{r as n,j as e,J as K,W as Ce,X as De,aL as C,ag as $,af as L,a9 as V,aM as Ne,Z as ke,aN as Se,aE as Ae,aO as Pe,ai as Fe,n as O,b as Ee,s,ad as G,t as ae,U as _e}from"./vendor-B-pOHZxB.js";import{u as $e,G as Te,H as ze,I as Ie,J as Be,K as Me}from"./index-C9q57MBf.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-DGlygaeZ.js";const Q=()=>new Date().toLocaleDateString("sv-SE",{timeZone:"America/Managua"}),ee=a=>{if(!a)return"—";const u=new Date(a.includes("T")?a:`${a}T12:00:00`);return new Intl.DateTimeFormat("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}).format(u)},te=ae`from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); }`,Re=ae`from { transform: scale(0.95); opacity: 0; } to { transform: scale(1); opacity: 1; }`,Le=s.div`
