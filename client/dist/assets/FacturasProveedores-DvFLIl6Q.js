import{r as n,j as e,I as V,W as Ge,X as qe,aM as Z,aN as $,ag as P,af as _,a9 as oe,aO as K,Z as Ye,aP as Xe,aK as Ue,aQ as Je,aj as ee,k as G,a as Qe,s as l,ad as re,t as Ne,U as Ze}from"./vendor-CKKIjxqY.js";import{u as Ke,I as er,A as rr,J as tr,K as ar,L as or,M as sr,N as nr,O as ir}from"./index-CtxqgSa7.js";import{r as lr}from"./searchEngine-BMYcElFi.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-BV71r4fP.js";const ye=()=>new Date().toLocaleDateString("sv-SE",{timeZone:"America/Managua"}),S=a=>{if(!a)return"—";const f=new Date(a.includes("T")?a:`${a}T12:00:00`);return new Intl.DateTimeFormat("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}).format(f)},se=Ne`from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); }`,dr=Ne`from { transform: scale(0.95); opacity: 0; } to { transform: scale(1); opacity: 1; }`,cr=l.div`
