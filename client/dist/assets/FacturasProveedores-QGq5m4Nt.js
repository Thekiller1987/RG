import{r as i,j as e,ad as V,V as Ae,W as De,aN as S,ag as z,af as O,a8 as Y,aO as te,aP as Se,Y as Pe,aQ as Fe,aG as ke,aR as Ee,ak as _e,n as q,b as $e,s as n,ac as W,t as se,T as Te}from"./vendor-bjMGIQJ7.js";import{u as ze,I as Ie,J as Be,K as Me,L as Re,M as Le}from"./index-D5OxzALZ.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-DPVwc1km.js";const ae=()=>new Date().toLocaleDateString("sv-SE",{timeZone:"America/Managua"}),I=a=>{if(!a)return"—";const f=new Date(a.includes("T")?a:`${a}T12:00:00`);return new Intl.DateTimeFormat("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}).format(f)},H=se`from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); }`,Ge=se`from { transform: scale(0.95); opacity: 0; } to { transform: scale(1); opacity: 1; }`,Ve=n.div`
