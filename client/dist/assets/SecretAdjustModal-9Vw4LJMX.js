import{r as l,j as e,Z as Be,$ as Oe,aQ as $e,a0 as We,a1 as Le,I as Pe,A as Ve,s as oe,m as _e,n as qe,u as Ge,R as Fe,aM as He,aZ as Ie,ae as Me,a$ as Ue,J as Se,x as ve,b0 as Je,b1 as Ye,af as Qe,b2 as Ze,a3 as Ke,b3 as Te,b4 as Xe,b5 as et,a8 as tt,aR as at,C as ze,q as ot,b6 as rt,b7 as it,b8 as nt}from"./vendor-bjMGIQJ7.js";import{d as st,S as A,h as lt,i as dt,j as ct,M as ce,a as he,B as k,f as L,I as ke}from"./POS.styles-Bl7oeOK9.js";import"./AlertModal-J0d4OT4p.js";import{u as Ee,a as pt}from"./index-D5OxzALZ.js";const z=r=>{const b=Number(r);return isNaN(b)||!isFinite(b)?0:b};function mt(r){if(!Array.isArray(r)||r.length===0)return[];const b=new Set,a=[];for(const v of r)v.id&&b.has(v.id)||(v.id&&b.add(v.id),a.push(v));return a}const xt=(r,b=0,a=36.6)=>{const v=Math.max(0,z(b)),I=z(a)||36.6,C={ventasContado:[],devoluciones:[],cancelaciones:[],entradas:[],salidas:[],abonos:[],ajustes:[]};let p=0,c=0,N=0,x=0,E=0,S=0,M=0,m=0;const T=mt(Array.isArray(r)?r:[]);for(const n of T){let o=((n==null?void 0:n.type)||"").toLowerCase().trim();o=o.normalize("NFD").replace(/[\u0300-\u036f]/g,"");let g=(n==null?void 0:n.pagoDetalles)||{};if(typeof g=="string")try{g=JSON.parse(g)}catch{g={}}(!g||typeof g!="object")&&(g={});const i=z(n.amount),w=z(g.totalVenta)||i,R=z(g.efectivo),B=z(g.dolares),G=z(g.cambio),j=z(g.ingresoCaja),J=z(g.tarjeta),K=z(g.transferencia),H=z(g.credito);let q=w||i;(o==="salida"||o.includes("devolucion")||o.includes("cancelacion")||o.includes("anulacion"))&&(q=-Math.abs(q));const $={...n,pagoDetalles:g,displayAmount:q};if(o.startsWith("venta")||o.includes("abono")||o.includes("pedido")||o.includes("apartado")?(N+=J,x+=K,E+=H):o==="ajuste"&&(g.target==="tarjeta"&&(N+=i),g.target==="credito"&&(E+=i),g.target==="transferencia"&&(x+=i)),o.startsWith("venta"))if(R>.001||B>.001||G>.001)p+=R-G,c+=B;else if(j>.001)p+=j;else{const O=J+K+H,W=w-O;W>.001&&(p+=W)}else if(o.includes("abono")||o.includes("liquidación")||o.includes("liquidacion")||o.includes("pedido"))if(B>.001)c+=B,p+=R;else if(R>.001)p+=R;else if(j>.001)p+=j;else{const O=J+K;p+=Math.max(0,i-O)}else if(o==="entrada")p+=Math.abs(i);else if(o==="salida")p-=Math.abs(i);else if(o.includes("devolucion")||o.includes("cancelacion")||o.includes("anulacion"))if(g.ingresoCaja!==void 0&&g.ingresoCaja!==null)p+=z(g.ingresoCaja);else if(R>.001)p-=R;else{const O=J+K+H,W=Math.abs(i)-O;W>.001&&(p-=W)}else if(o==="ajuste")g.target==="efectivo"?(p+=i,g.hidden&&(m+=i)):g.target==="dolares"&&(c+=i);else{const O=J+K+H,W=i-O;Math.abs(W)>.001&&(p+=W)}o.startsWith("venta")||o.includes("abono")||o.includes("liquid")||o.includes("pedido")||o==="entrada"?M+=Math.abs(q):o.includes("devolucion")||o.includes("cancelacion")||o.includes("anulacion")?M-=Math.abs(q):o==="ajuste"&&g.target==="ventas_totales"&&(M+=i),o.startsWith("venta")?C.ventasContado.push($):o.includes("devolucion")?(C.devoluciones.push($),S+=Math.abs(q)):o.includes("cancelacion")||o.includes("anulacion")?(C.cancelaciones.push($),S+=Math.abs(q)):o==="entrada"?C.entradas.push($):o==="salida"?C.salidas.push($):o.includes("abono")?C.abonos.push($):o==="ajuste"&&C.ajustes.push($)}p=z(p),c=z(c),N=z(N),x=z(x),E=z(E),M=z(M),m=z(m),S=z(S);const t=v+p,f=t+c*I;return{cajaInicial:v,netCordobas:p,netDolares:c,efectivoEsperado:z(f),efectivoEsperadoCordobas:z(t),efectivoEsperadoDolares:c,totalVentasDia:z(M),totalTarjeta:N,totalTransferencia:x,totalCredito:E,totalNoEfectivo:z(N+x+E),sumDevolucionesCancelaciones:S,totalHidden:m,tasaRef:I,lists:C}},je=r=>Number(r||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}),Re=oe.button`
...
`,ft=({isOpen:r,imageSrc:b,onClose:a})=>!r||!b?null:e.jsx(ce,{onClick:a,children:e.jsxs(_e.div,{initial:{scale:.9,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.9,opacity:0},onClick:v=>v.stopPropagation(),style:{position:"relative",maxWidth:"95%",maxHeight:"90vh"},children:[e.jsx("button",{onClick:a,style:{position:"absolute",top:-15,right:-15,background:"white",width:32,height:32,borderRadius:"50%",border:"none",cursor:"pointer",boxShadow:"0 4px 6px rgba(0,0,0,0.1)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:10,color:"#ef4444"},children:e.jsx(qe,{})}),e.jsx("img",{src:b,alt:"Vista Ampliada",style:{maxWidth:"100%",maxHeight:"85vh",borderRadius:"12px",boxShadow:"0 20px 25px rgba(0,0,0,0.2)",background:"white",objectFit:"contain"}})]})});function Tt({products:r=[],searchTerm:b,setSearchTerm:a,onProductClick:v,cartItems:I=[],reservedStock:C,inputRef:p,searchType:c="description",setSearchType:N=()=>{},isWholesale:x=!1}){const[E,S]=l.useState({isOpen:!1,imageUrl:null}),M=l.useMemo(()=>{const t=new Map;for(const f of I){const n=f.id_producto||f.id;t.set(n,(t.get(n)||0)+Number(f.quantity||0))}return t},[I]),m=l.useMemo(()=>{const t=(b||"").toLowerCase().trim();return r.filter(n=>{const o=i=>i?String(i).normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase():"",g=o(t);if(!g)return!0;if(c==="code"){const i=o(n.codigo),w=o(n.codigo_barras);return i.startsWith(g)||w.startsWith(g)}else{const i=o(n.nombre),w=o(n.descripcion),R=o(n.codigo);return i.includes(g)||w.includes(g)||R.includes(g)}}).slice(0,100)},[r,b,c]),T=l.useMemo(()=>{const t=(b||"").toLowerCase().trim();return t?r.filter(f=>{const n=(f.nombre||"").toLowerCase(),o=String(f.codigo||"").toLowerCase();return n.includes(t)||o.includes(t)}).length:r.length},[r,b]);return e.jsxs(st,{children:[e.jsxs("div",{style:{display:"flex",gap:"8px",marginBottom:"1rem",alignItems:"center"},children:[e.jsx(A,{ref:p,placeholder:c==="code"?"Escribe código...":"Buscar producto...",value:b,onChange:t=>a(t.target.value),onKeyDown:t=>{if(t.key==="Enter"){const f=(b||"").trim().toLowerCase();if(!f)return;const n=r.find(o=>String(o.codigo||"").toLowerCase()===f||String(o.codigo_barras||"").toLowerCase()===f);if(n){v(n),a("");return}m.length===1&&(v(m[0]),a(""))}}}),e.jsx(Re,{$active:c==="description",onClick:()=>{var t;N("description"),(t=p.current)==null||t.focus()},title:"Buscar por Nombre",children:e.jsx(Be,{size:16})}),e.jsx(Re,{$active:c==="code",onClick:()=>{var t;N("code"),(t=p.current)==null||t.focus()},title:"Buscar por Código",children:e.jsx(Oe,{size:18})})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"8px",padding:"0 4px",fontSize:"0.85rem",color:"#64748b"},children:[e.jsxs("span",{children:[e.jsx($e,{color:"#3b82f6"})," ",m.length," mostrados"]}),e.jsxs("span",{children:["Total: ",T]})]}),e.jsx(lt,{children:m.map(t=>{const f=t.id_producto||t.id,n=M.get(f)||0,o=(C==null?void 0:C.get(f))||0,g=Math.max(0,Number(t.existencia||0)-n-o),i=g<=0;return e.jsxs(dt,{onClick:()=>!i&&v(t),outOfStock:i,title:t.nombre,children:[e.jsx(ct,{lowstock:g<5&&!i,outOfStock:i,children:i?"Agotado":`Stock: ${g}`}),e.jsxs("div",{className:"image-placeholder",style:{position:"relative",height:160,background:"#f8fafc",display:"flex",alignItems:"center",justifyContent:"center",borderBottom:"1px solid #f1f5f9",overflow:"hidden"},children:[t.imagen&&e.jsx("div",{className:"eye-icon",onClick:w=>{w.stopPropagation(),S({isOpen:!0,imageUrl:t.imagen})},style:{position:"absolute",top:10,left:10,zIndex:20,background:"white",borderRadius:"50%",width:32,height:32,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 6px rgba(0,0,0,0.1)",cursor:"pointer",transition:"transform 0.2s"},title:"Ver imagen",children:e.jsx(We,{size:14,color:"#64748b"})}),t.imagen?e.jsx("img",{src:t.imagen,alt:t.nombre,loading:"lazy",style:{maxWidth:"100%",maxHeight:"100%",objectFit:"contain"}}):e.jsx(Le,{className:"no-image-icon",size:40,color:"#e2e8f0"})]}),e.jsxs("div",{className:"info",style:{padding:"12px",flex:1,display:"flex",flexDirection:"column",gap:"4px"},children:[e.jsx("div",{className:"product-name",style:{fontWeight:600,fontSize:"0.88rem",color:"#1e293b",lineHeight:"1.25",height:"3.8rem",overflow:"hidden",display:"-webkit-box",WebkitLineClamp:3,WebkitBoxOrient:"vertical"},children:t.nombre}),e.jsx("div",{style:{fontSize:"0.85rem",fontWeight:"bold",color:"#334155",marginBottom:"4px"},children:t.codigo||"S/C"}),x?e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{fontSize:"0.75rem",color:"#64748b",display:"flex",alignItems:"center",gap:"4px",marginTop:"auto",marginBottom:"1px",textDecoration:"line-through"},children:["Tienda: C$ ",je(t.precio_venta||t.precio)]}),e.jsxs("div",{className:"price",style:{fontWeight:800,color:"#8b5cf6",fontSize:"1.1rem"},children:["C$ ",je(t.mayorista||t.mayoreo||t.distribuidor||t.taller||t.precio_venta)]})]}):e.jsxs(e.Fragment,{children:[(Number(t.mayorista)>0||Number(t.mayoreo)>0||Number(t.distribuidor)>0||Number(t.taller)>0)&&e.jsxs("div",{style:{fontSize:"0.75rem",color:"#10b981",display:"flex",alignItems:"center",gap:"4px",marginTop:"auto",marginBottom:"1px"},children:[e.jsx(Pe,{size:10})," May: C$ ",je(t.mayorista||t.mayoreo||t.distribuidor||t.taller)]}),e.jsxs("div",{className:"price",style:{fontWeight:800,color:"#2563eb",fontSize:"1.05rem",marginTop:Number(t.mayorista)>0||Number(t.mayoreo)>0||Number(t.distribuidor)>0||Number(t.taller)>0?0:"auto"},children:["C$ ",je(t.precio_venta||t.precio)]})]})]})]},f)})}),e.jsx(Ve,{children:E.isOpen&&e.jsx(ft,{isOpen:!0,imageSrc:E.imageUrl,onClose:()=>S({isOpen:!1,imageUrl:null})})})]})}const gt=Fe.memo(()=>e.jsx("style",{children:`
...
`,zt=({currentUser:r,isCajaOpen:b,session:a,onOpenCaja:v,onCloseCaja:I,onClose:C,isAdmin:p,showConfirmation:c,showAlert:N,initialTasaDolar:x,clients:E=[]})=>{var me,xe;const[S,M]=l.useState(""),[m,T]=l.useState(x||36.6),[t,f]=l.useState(""),[n,o]=l.useState(!1),g=Ge(),i=(r==null?void 0:r.id_usuario)||(r==null?void 0:r.id);let w=(me=a==null?void 0:a.openedBy)==null?void 0:me.name;!w&&(a!=null&&a.openedBy)&&typeof a.openedBy=="string"&&(w=a.openedBy),w||(w=(a==null?void 0:a.userId)===i?(r==null?void 0:r.nombre_usuario)||(r==null?void 0:r.username):"Usuario"),w||(w="Caja General");const R=p||(a==null?void 0:a.userId)===i||((xe=a==null?void 0:a.openedBy)==null?void 0:xe.id)===i,B=l.useMemo(()=>Array.isArray(a==null?void 0:a.transactions)?a.transactions:[],[a]),G=l.useMemo(()=>{const d=xt(B,(a==null?void 0:a.initialAmount)||0,(a==null?void 0:a.tasaDolar)||x);if(a!=null&&a.stats&&typeof a.stats=="object")return{...a.stats,lists:a.stats.lists||d.lists};if(a!=null&&a.sqlTotals){const u=a.sqlTotals,se=(a==null?void 0:a.initialAmount)||0;return{cajaInicial:se,netCordobas:u.efectivo,netDolares:u.dolares,movimientoNetoEfectivo:u.esperado-se,efectivoEsperado:u.esperado,efectivoEsperadoCordobas:u.efectivo+se,efectivoEsperadoDolares:u.dolares,totalTarjeta:u.tarjeta,totalTransferencia:u.transferencia,totalCredito:u.credito,totalNoEfectivo:u.tarjeta+u.transferencia+u.credito,tasaRef:(a==null?void 0:a.tasaDolar)||x,lists:d.lists}}return d},[B,a,x]),{cajaInicial:j,netCordobas:J,netDolares:K,efectivoEsperado:H,efectivoEsperadoCordobas:q,efectivoEsperadoDolares:pe,totalVentasDia:$,totalTarjeta:O,totalTransferencia:W,totalCredito:re,totalNoEfectivo:X,sumDevolucionesCancelaciones:y,totalHidden:de,tasaRef:te,lists:{ventasContado:be,devoluciones:Y,cancelaciones:ie,entradas:D,salidas:P,abonos:V}}=G,F=Number(t||0)-H;a!=null&&a.openedAt&&new Date(a.openedAt);const Q=()=>{const d=parseFloat(S||0);if(isNaN(d)||d<0)return N({title:"Inválido",message:"Monto inicial >= 0"});v(d,Number(m||36.6))},ne=()=>{if(isNaN(parseFloat(t)))return N({title:"Requerido",message:"Ingrese el monto contado físico."});o(!0)},Z=Fe.useCallback(()=>{const d=document.getElementById("print-wrapper-caja");if(!d)return;const u=d.outerHTML,se=`
        @charset "UTF-8";
        @import url('https://fonts.googleapis.com/css2?family=League+Spartan:wght@400;600;800;900&display=swap');
...
`,Et=({cart:r=[],total:b=0,subtotal:a=0,discount:v=0,proformaFor:I="",onClose:C,currentUser:p,client:c})=>{const{user:N}=typeof Ee=="function"?Ee():{user:null},{settings:x}=pt(),E=i=>(i==null?void 0:i.usuarioNombre)||(i==null?void 0:i.nombre_usuario)||(i==null?void 0:i.name)||(i==null?void 0:i.nombre)||(i==null?void 0:i.username)||null;let S=null;try{S=JSON.parse(localStorage.getItem("authUser")||"null")}catch{}const M=E(p)||E(N)||E(S)||"Cajero POS",m=(c==null?void 0:c.nombre)||"Consumidor Final",T=(c==null?void 0:c.cedula)||"",t=new Date().toLocaleString("es-NI"),f=i=>new Intl.NumberFormat("es-NI",{minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(i||0)),n={name:(x==null?void 0:x.empresa_nombre)||"Multirepuestos RG",ruc:(x==null?void 0:x.empresa_ruc)||"1211812770001E",phone:(x==null?void 0:x.empresa_telefono)||"84031936 / 84058142",address:(x==null?void 0:x.empresa_direccion)||"Del portón de la normal 75 varas al este. Juigalpa, Chontales.",slogan:(x==null?void 0:x.empresa_eslogan)||"Tu mejor opción en repuestos",logo:(x==null?void 0:x.empresa_logo_url)||new URL("/icons/logo.png",window.location.origin).toString()},o=l.useCallback((i="80")=>{const w=document.getElementById("print-wrapper-proforma");if(!w)return;const R=w.outerHTML,G=`
      @charset "UTF-8";
