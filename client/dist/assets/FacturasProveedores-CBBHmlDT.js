import{r as n,j as e,J as V,Y as Ae,Z as Se,aO as D,ai as I,ah as O,ab as Y,aP as te,aQ as De,a0 as Pe,aR as Fe,aH as ke,aS as Ee,al as _e,n as q,b as $e,s,af as W,t as se,W as ze}from"./vendor-CmfT02pU.js";import{u as Ie,J as Te,A as Be,K as Me,L as Re,M as Le}from"./index-wFii9qvY.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-ClxtRhIU.js";const ae=()=>new Date().toLocaleDateString("sv-SE",{timeZone:"America/Managua"}),T=t=>{if(!t)return"—";const f=new Date(t.includes("T")?t:`${t}T12:00:00`);return new Intl.DateTimeFormat("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}).format(f)},H=se`from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); }`,Ge=se`from { transform: scale(0.95); opacity: 0; } to { transform: scale(1); opacity: 1; }`,Ve=s.div`
