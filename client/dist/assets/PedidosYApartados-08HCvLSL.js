import{R as v,r as x,j as e,C as le,x as ve,a8 as ke,s as i,t as R,a9 as Ce,aa as Se,W as Ne,v as ze,X as Ae,ab as ge,a0 as Ee,a1 as de,$ as ce,G as Te,k as he,ac as pe,ad as Ie,Y as Fe,a5 as Pe,A as $e,m as re,ae as Oe,a6 as _e,a7 as Re}from"./vendor-C4uQ3a2a.js";import{r as De}from"./searchEngine-BMYcElFi.js";import{a as Le,u as ue,e as Me,h as Be,i as We,j as qe,k as Ve,f as be}from"./index-DKlUidKK.js";import{h as He,E as Ue}from"./pdf-vendor-BMvqz6Um.js";import{H as Ge}from"./scanner-vendor-DfxRpMWJ.js";const Ye=R`from { opacity: 0; } to { opacity: 1; }`,Qe=R`from { transform: scale(0.95); } to { transform: scale(1); }`,Ke=R`0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); }`,ne=i.div`
...
`,nt=({title:n,message:f,type:u="info",onClose:p})=>{const a=()=>u==="error"?"#ef4444":u==="success"?"#10b981":"#3b82f6",b=()=>u==="error"?e.jsx(Ce,{size:40,color:a()}):u==="success"?e.jsx(Se,{size:40,color:a()}):e.jsx(Ne,{size:40,color:a()});return e.jsx(ne,{style:{zIndex:2e3},children:e.jsxs(ae,{style:{maxWidth:"350px",textAlign:"center",padding:"2rem"},children:[e.jsx("div",{style:{marginBottom:"1rem"},children:b()}),e.jsx("h3",{style:{color:"#1e293b",margin:"0 0 10px 0"},children:n}),e.jsx("p",{style:{color:"#64748b",fontSize:"0.95rem",margin:"0 0 20px 0"},children:f}),e.jsx(_,{onClick:p,style:{width:"100%",padding:"12px"},children:"Entendido"})]})})},at=({cart:n=[],total:f=0,subtotal:u=0,discount:p=0,proformaFor:a="",proformaNumber:b="",onClose:s,setTicketData:g,currentUser:y,client:w})=>{const[j,k]=v.useState(!1),D=x.useRef(null),{settings:l}=Le(),{cajaSession:S,user:N}=ue()||{},[I,P]=v.useState(!1),[V,H]=v.useState(!1),[L,U]=v.useState([]),[$,G]=v.useState(""),[F,M]=v.useState(null),[T,B]=v.useState({isOpen:!1,title:"",message:"",type:"info"}),z=(o,d,c="info")=>{B({isOpen:!0,title:o,message:d,type:c})},W=()=>{B(o=>({...o,isOpen:!1})),T.type==="success"&&(g(),s&&s())},A=o=>new Intl.NumberFormat("es-NI",{minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(o||0)),Q=(o=>(o==null?void 0:o.usuarioNombre)||(o==null?void 0:o.nombre)||"Empleado")(y),O=(w==null?void 0:w.nombre)||a||"Consumidor Final",K=(w==null?void 0:w.telefono)||"N/D",q=v.useMemo(()=>{if(!(l!=null&&l.empresa_logo_url))return null;if(l.empresa_logo_url.startsWith("http"))return l.empresa_logo_url;let o=l.empresa_logo_url;return o.startsWith("/uploads")?o="/api"+o:o.startsWith("uploads")&&(o="/api/"+o),`${"https://sistema.multirepuestosrg.com/api".replace(/\/api$/,"")}${o.startsWith("/")?"":"/"}${o}`},[l==null?void 0:l.empresa_logo_url]),C={name:(l==null?void 0:l.empresa_nombre)||"Multirepuestos RG",ruc:(l==null?void 0:l.empresa_ruc)||"1211812770001E",phone:(l==null?void 0:l.empresa_telefono)||"84031936 / 84058142",address:(l==null?void 0:l.empresa_direccion)||"Del portón de la normal 75 varas al este. Juigalpa, Chontales.",slogan:(l==null?void 0:l.empresa_eslogan)||"Tu mejor opción en repuestos de moto y carro",logo:q||new URL("/icons/logo.png",window.location.origin).toString()};v.useEffect(()=>{G(`Pedido - ${O}`)},[O]);const J=async()=>{if(n.length===0)return;k(!0);const o=D.current,d=O.replace(/\s/g,"_").replace(/[^a-zA-Z0-9_]/g,""),c=b.trim()?`N${b.trim()}`:"TEMP",h=`PROFORMA_${d}_${c}.pdf`,r=o.cloneNode(!0);r.classList.add("proforma-to-print"),r.style.position="absolute",r.style.left="-9999px",r.style.top="0",r.style.width="794px",r.style.padding="40px",r.style.boxSizing="border-box",r.style.background="#ffffff",r.style.boxShadow="none",r.style.border="none",document.body.appendChild(r);try{const m=await He(r,{scale:2,useCORS:!0,windowWidth:794}),Z=m.toDataURL("image/jpeg",1),ie=new Ue("p","mm","a4"),se=210,we=m.height*se/m.width;ie.addImage(Z,"JPEG",0,0,se,we),ie.save(h),g()}catch(m){console.error("Error al generar PDF:",m),z("Error","❌ Error al generar y descargar el PDF.","error")}finally{document.body.contains(r)&&document.body.removeChild(r),k(!1),s&&s()}},X=async()=>{var d,c;if(n.length===0)return;P(!0);const o=localStorage.getItem("token");try{const h=await Me(o);let r=(h==null?void 0:h.abiertas)||[];if(r.length===0&&S&&!S.closedAt){const m=((d=S.openedBy)==null?void 0:d.id)||((N==null?void 0:N.id_usuario)??(N==null?void 0:N.id)),Z=((c=S.openedBy)==null?void 0:c.name)||(N==null?void 0:N.nombre_usuario)||"Cajero";r=[{id:S.id,openedAt:S.openedAt,openedBy:{id:m,name:Z}}]}if(r.length===0){z("Atención","⚠️ No hay cajas abiertas en este momento. Abre una caja primero desde el POS antes de enviar el pedido.","warning"),P(!1);return}U(r),r.length>0&&M(r[0].openedBy.id),H(!0),P(!1)}catch(h){console.error("Error fetching sessions:",h),z("Error","❌ Error al buscar cajas activas.","error"),P(!1)}},t=async()=>{if(!F)return z("Atención","Seleccione una caja.","warning");if(!$.trim())return z("Atención","Ingrese un nombre para el ticket.","warning");P(!0);const o=localStorage.getItem("token");try{const d=await Be(F,o)||[],c={id:Date.now(),name:$,items:n,createdAt:new Date().toISOString(),createdBy:Q},r=[...Array.isArray(d)?d:[],c];await We(F,r,o),H(!1),z("Éxito",`✅ Ticket "${$}" enviado exitosamente a la caja.`,"success")}catch(d){console.error("Error sending ticket:",d),z("Error","❌ Error al enviar el ticket a la caja. Intente de nuevo.","error")}finally{P(!1)}};return e.jsxs(v.Fragment,{children:[e.jsx(ne,{style:{zIndex:V||T.isOpen?1099:1100},children:e.jsx(ae,{children:e.jsxs(Je,{ref:D,children:[e.jsxs(Xe,{children:[e.jsx("div",{className:"brand-logo-container",children:e.jsx("img",{src:C.logo,alt:"Logo",className:"logo",onError:o=>{o.currentTarget.style.display="none"}})}),e.jsxs("div",{className:"brand-info",children:[e.jsx("h1",{children:C.name}),e.jsx("small",{children:C.slogan}),e.jsxs("small",{children:["RUC: ",C.ruc]}),e.jsxs("small",{children:["Tel: ",C.phone]}),e.jsx("small",{children:C.address}),e.jsx("div",{children:e.jsxs("span",{className:"proforma-tag",children:[e.jsx(le,{style:{marginRight:4,verticalAlign:"middle"}})," COTIZACIÓN / PROFORMA"]})})]})]}),e.jsxs(Ze,{children:[e.jsxs("div",{className:"meta-col",children:[e.jsx("span",{className:"meta-title",children:"Detalles"}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Fecha:"}),e.jsxs("span",{className:"meta-value",children:[new Date().toLocaleDateString("es-NI")," ",new Date().toLocaleTimeString("es-NI",{hour:"2-digit",minute:"2-digit"})]})]}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"ID Temp:"}),e.jsx("span",{className:"meta-value",children:Date.now().toString().slice(-6)})]}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Atendido por:"}),e.jsx("span",{className:"meta-value",children:Q})]})]}),e.jsxs("div",{className:"meta-col",children:[e.jsx("span",{className:"meta-title",children:"Cliente"}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Nombre:"}),e.jsx("span",{className:"meta-value",children:O})]}),e.jsxs("p",{children:[e.jsx("span",{className:"meta-label",children:"Teléfono:"}),e.jsx("span",{className:"meta-value",children:K})]})]})]}),e.jsxs(et,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{className:"col-qty",children:"CANT."}),e.jsx("th",{children:"DESCRIPCIÓN"}),e.jsx("th",{className:"col-unit",children:"PRECIO UNIT."}),e.jsx("th",{className:"col-total",children:"TOTAL"})]})}),e.jsx("tbody",{children:n.length===0?e.jsx("tr",{children:e.jsx("td",{colSpan:"4",style:{textAlign:"center",color:"#777"},children:"No hay artículos."})}):n.map((o,d)=>{const c=parseFloat(o.precio_venta??o.precio??0),h=parseFloat(o.quantity??0);return e.jsxs("tr",{children:[e.jsx("td",{className:"col-qty",children:h}),e.jsx("td",{children:o.nombre||"Artículo sin nombre"}),e.jsxs("td",{className:"col-unit",children:["C$ ",A(c)]}),e.jsxs("td",{className:"col-total",children:["C$ ",A(h*c)]})]},d)})})]}),e.jsxs(tt,{children:[e.jsxs("div",{className:"note-section",children:[e.jsx("p",{children:e.jsx("strong",{children:"Nota:"})}),e.jsxs("p",{children:['"',C.slogan,'"']}),e.jsx("p",{children:"Precios sujetos a cambios y stock. Válido por 3 días."}),e.jsx("p",{style:{whiteSpace:"pre-line",marginTop:"5px",fontWeight:"bold"},children:(l==null?void 0:l.ticket_proforma_footer)||"¡Gracias por cotizar con nosotros!"})]}),e.jsxs(ot,{children:[e.jsxs(ee,{children:[e.jsx("span",{children:"Subtotal:"}),e.jsxs("span",{className:"text-right",children:["C$ ",A(u)]})]}),p>0&&e.jsxs(ee,{style:{color:"#dc3545"},children:[e.jsx("span",{children:"Descuento:"}),e.jsxs("span",{className:"text-right",children:["- C$ ",A(p)]})]}),e.jsxs(ee,{className:"grand-total",children:[e.jsx("span",{children:"TOTAL:"}),e.jsxs("span",{className:"text-right",children:["C$ ",A(f)]})]}),e.jsx("div",{className:"badge-container",children:e.jsx("span",{className:"badge",children:"DOCUMENTO NO VÁLIDO COMO FACTURA"})})]})]}),e.jsxs("div",{className:"footer-actions",style:{display:"flex",gap:"1rem",marginTop:"1rem",flexWrap:"wrap"},children:[e.jsxs(_,{$cancel:!0,onClick:s,style:{flex:1},disabled:j||I,children:[e.jsx(ve,{})," Cerrar"]}),e.jsxs(_,{onClick:X,disabled:n.length===0||j||I,style:{flex:1,background:"#f59e0b"},children:[I?e.jsx(te,{}):e.jsx(le,{}),"ENVIAR A CAJA"]}),e.jsxs(_,{onClick:J,disabled:n.length===0||j||I,style:{flex:1,background:"#059669"},children:[j?e.jsx(te,{}):e.jsx(ke,{}),"PDF"]})]})]})})}),V&&e.jsx(ne,{style:{zIndex:1200},children:e.jsxs(ae,{style:{maxWidth:"400px",textAlign:"center"},children:[e.jsx("h3",{style:{color:"#0f172a",marginBottom:"1rem"},children:"Enviar Pedido a Caja"}),e.jsxs("div",{style:{textAlign:"left",marginBottom:"1rem"},children:[e.jsx("label",{style:{display:"block",marginBottom:"5px",fontWeight:"bold",fontSize:"0.9rem"},children:"Nombre del Ticket:"}),e.jsx("input",{type:"text",value:$,onChange:o=>G(o.target.value),style:{width:"100%",padding:"10px",borderRadius:"8px",border:"1px solid #ccc"}})]}),e.jsxs("div",{style:{textAlign:"left",marginBottom:"1.5rem"},children:[e.jsx("label",{style:{display:"block",marginBottom:"5px",fontWeight:"bold",fontSize:"0.9rem"},children:"Seleccionar Caja:"}),e.jsx("select",{value:F||"",onChange:o=>M(o.target.value),style:{width:"100%",padding:"10px",borderRadius:"8px",border:"1px solid #ccc"},children:L.map(o=>e.jsxs("option",{value:o.openedBy.id,children:[o.openedBy.name," - (Abierta: ",new Date(o.openedAt).toLocaleTimeString(),")"]},o.openedBy.id))})]}),e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(_,{$cancel:!0,onClick:()=>H(!1),style:{flex:1},children:"Cancelar"}),e.jsx(_,{onClick:t,disabled:I,style:{flex:1},children:I?e.jsx(te,{}):"Enviar Ticket"})]})]})}),T.isOpen&&e.jsx(nt,{title:T.title,message:T.message,type:T.type,onClose:W})]})},E=new Map;async function xe(n,f=4){const u=localStorage.getItem("token"),p=n.filter(s=>{const g=E.get(s);return!g||g!=="loading"&&g!=="none"});let a=0;async function b(){if(a>=p.length)return;const s=p[a++];if(E.has(s))return b();E.set(s,"loading");try{const g=await be(s,u),y=(g==null?void 0:g.imagen)||"none";E.set(s,y),window.dispatchEvent(new CustomEvent(`image_loaded_${s}`,{detail:y}))}catch{E.set(s,"none"),window.dispatchEvent(new CustomEvent(`image_loaded_${s}`,{detail:"none"}))}return b()}await Promise.all(Array.from({length:f},b))}function rt(n){const[f,u]=v.useState(()=>{const a=E.get(n);return a&&a!=="loading"&&a!=="none"?a:null}),p=v.useRef(null);return v.useEffect(()=>{const a=E.get(n);if(a&&a!=="loading"&&a!=="none"){u(a);return}if(a==="none")return;const b=g=>{const y=g.detail;y&&y!=="none"&&u(y)};window.addEventListener(`image_loaded_${n}`,b);const s=new IntersectionObserver(g=>{if(g[0].isIntersecting){const y=E.get(n);if(!y||y!=="loading"&&y!=="none"){const w=localStorage.getItem("token");E.set(n,"loading"),be(n,w).then(j=>{const k=(j==null?void 0:j.imagen)||"none";E.set(n,k),k!=="none"&&u(k),window.dispatchEvent(new CustomEvent(`image_loaded_${n}`,{detail:k}))}).catch(()=>{E.set(n,"none"),window.dispatchEvent(new CustomEvent(`image_loaded_${n}`,{detail:"none"}))})}}},{rootMargin:"200px"});return p.current&&s.observe(p.current),()=>{s.disconnect(),window.removeEventListener(`image_loaded_${n}`,b)}},[n]),{imgSrc:f,ref:p}}function it({productId:n,productName:f,onView:u}){const{imgSrc:p,ref:a}=rt(n);return e.jsxs("div",{ref:a,style:{height:160,background:"#f8fafc",display:"flex",alignItems:"center",justifyContent:"center",position:"relative",overflow:"hidden"},children:[p&&e.jsx("div",{className:"eye-icon",onClick:b=>{b.stopPropagation(),u(p)},style:{position:"absolute",top:10,left:10,zIndex:20,background:"white",borderRadius:"50%",width:32,height:32,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 6px rgba(0,0,0,0.1)",cursor:"pointer"},title:"Ver imagen",children:e.jsx(_e,{size:14,color:"#64748b"})}),p?e.jsx("img",{src:p,alt:f,style:{width:"100%",height:"100%",objectFit:"contain"}}):e.jsx(Re,{size:40,color:"#e2e8f0"})]})}const st=R`
