// client/src/pages/pos/components/OrderDetailModal.jsx
...
        } catch (error) {
            // Log refinado
            console.error(`Error al cargar detalles del pedido #${pedidoId}:`, error.message || error);
...
        } catch (error) {
            // Log refinado
            console.error(`Error al registrar abono del pedido #${pedidoId}:`, error.message || error);
...
                } catch (error) {
                    // Log refinado
                    console.error(`Error al liquidar pedido #${pedidoId}:`, error.message || error);
...
                } catch (error) {
                    // Log refinado
                    console.error(`Error al cancelar pedido #${pedidoId}:`, error.message || error);
