              ...
              <div style={{ background: '#fff', padding: 20, borderRadius: 8, boxShadow: '0 2px 10px rgba(0,0,0,0.05)', marginBottom: 20 }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <tbody>
                    ...
                    {entradas.length > 0 && <tr><td style={{ padding: '4px 10px 4px 20px', fontSize: '0.9rem', color: '#28a745' }}>(+) Entradas de Efectivo</td><td className="text-right" style={{ padding: '4px 10px', fontSize: '0.9rem', color: '#28a745' }}>+ {money(entradas.reduce((a, b) => a + Math.abs(b.displayAmount || 0), 0))}</td></tr>}
