...
// [Styled Components - Se mantienen intactos]
...
    } catch (err) {
      // Log refinado: Solo muestra el mensaje de error o el objeto si no tiene mensaje.
...
    } catch (err) {
      // Log refinado: Solo muestra el mensaje de error o el objeto si no tiene mensaje.
      console.error("Error al registrar abono:", err.message || err);
      showAlert({ title: "Error", message: `No se pudo registrar el abono. ${err.message || 'Error desconocido'}` });
    } finally {
      setIsLoading(false);
