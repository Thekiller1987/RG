...
// VERSIÓN FINAL LISTA PARA NETLIFY
// ==========================================================
...
const API_BASE_URL = process.env.NODE_ENV === 'production'
    ? '/api'                     // Netlify: redirección de /api/* a la función server.js
    : 'http://localhost:8888/api'; // Desarrollo local con Netlify Dev u otro puerto
