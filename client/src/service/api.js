...
export const payProviderInvoice = async (invoiceId, amount, reference, status, token) => {
    return await request('post', `/facturas-proveedores/${invoiceId}/pagar`, token, { amount, reference, status });
};
